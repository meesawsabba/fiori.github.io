...
sap.ui.define([
	...
	GanttResizeExtension.prototype.renderResizeTriggerAndCover = function(mPath, oGroup, bHover, oElement) {
		...
		if (!bHover){
			var mCoverAttr = this.getResizeRectCoverAttrs(oElement);
	...
	GanttResizeExtension.prototype.getResizeRectCoverAttrs = function(oElement) {
		var frame = this.getFrame(),
			iMargin = this.getMargin(),
