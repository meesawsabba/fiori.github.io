 ...
 */
sap.ui.define([
	"./BaseShape", "./RenderUtils", "./GanttUtils", "../misc/Format", "sap/gantt/misc/Utility", "sap/gantt/library"
], function (BaseShape, RenderUtils, GanttUtils, Format, Utility, library) {
	"use strict";
	...
	BaseRectangle.prototype.getWidth = function () {
		...
		var nRetVal;
		var oShapeData = GanttUtils.isShapeLargerThanTotalHorizon(this);

		var startTime = oAxisTime.timeToView(oShapeData.startTime),
			endTime = oAxisTime.timeToView(oShapeData.endTime);
