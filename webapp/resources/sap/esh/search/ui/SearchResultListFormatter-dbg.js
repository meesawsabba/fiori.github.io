...
sap.ui.define([
    ...
    "sap/esh/search/ui/SearchNavigationObject",
    "sap/esh/search/ui/SearchNavigationObjectForSinaNavTarget",
], function (SearchHelper, SearchNavigationObject, SearchNavigationObjectForSinaNavTarget) {
    "use strict";
    var module = (sap.esh.search.ui.SearchResultListFormatter = function () {
    ...
    module.prototype = {
        ...
        format: function (searchResultSet, terms, options) {
            ...
            for (i = 0; i < resultItems.length; i++) {
                ...
                for (z = 0; z < resultItem.detailAttributes.length; z++) {
                    ...
                    switch (detailAttribute.metadata.type) {
                        ...
                        case sina.AttributeType.ImageUrl:
                            ...
                            formattedResultItem.imageFormat = detailAttribute.metadata.format
                                ? detailAttribute.metadata.format.toLowerCase()
                                : undefined;
                            if (detailAttribute.defaultNavigationTarget) {
                                formattedResultItem.imageNavigation =
                                    new SearchNavigationObjectForSinaNavTarget(detailAttribute.defaultNavigationTarget, this.model);
                            }
                            break;
                ...
                if (resultItem.additionalAttributes) {
                    formattedResultItem.additionalAttributes = resultItem.additionalAttributes;
                }
                ...
                if (resultItem.navigationTargets && resultItem.navigationTargets.length > 0) {
                    ...
                    for (var j = 0; j < resultItem.navigationTargets.length; j++) {
                        var navigationTarget = new SearchNavigationObjectForSinaNavTarget(resultItem.navigationTargets[j], this.model);
        ...
        _formatAttributeGroup: function (attributeGroup, options, index) {
            ...
            if (attributeGroup.attributes.length === 2 &&
                ...
                formattedAttr.displayOrder =
                    attributeGroup.metadata.usage.Detail &&
                        attributeGroup.metadata.usage.Detail.displayOrder;
                // if (isLongtext) {
            ...
            if (Object.keys(attributes).length > 0) {
                ...
                if (privateGroupMetadata &&
                    ...
                    parentAttributeValue =
                        parentAttributeValue !== undefined && parentAttributeValue.trim().length > 0
                            ? parentAttributeValue
                            : undefined;
                    childAttributeValue =
                        childAttributeValue !== undefined && childAttributeValue.trim().length > 0
                            ? childAttributeValue
                            : undefined;
        ...
        _formatSingleAttribute: function (detailAttribute, options, index) {
            ...
            oItemAttribute.displayOrder =
                detailAttribute.metadata.usage.Detail &&
                    detailAttribute.metadata.usage.Detail.displayOrder;
            ...
            if (detailAttribute.metadata.format &&
        ...
        _formatBasedOnGroupTemplate: function (template, attributes, valuePropertyName) {
            ...
            while ((match = regex.exec(template)) !== null) {
                ...
                value +=
                    (attributes[attributeName] && attributes[attributeName][valuePropertyName]) || "";
                pos = regex.lastIndex;
            }
        ...
        _formatResultForDocuments: function (resultItem, additionalParameters) {
            ...
            if (additionalParameters.isDocumentConnector === true) {
                ...
                var suvlink = "/sap/opu/odata/SAP/ESH_SEARCH_SRV" +
                    sidClient +
                    "/FileLoaderFiles(ConnectorId='" +
                    connectorName +
        ...
        _formatResultForNotes: function () { },
    };
    return module;
});
