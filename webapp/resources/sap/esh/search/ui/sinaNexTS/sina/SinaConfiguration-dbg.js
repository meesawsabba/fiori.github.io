...
sap.ui.define(["require", "exports"], function (require, exports) {
    ...
    exports._normalizeConfiguration = exports.AvailableProviders = void 0;
    ...
    })(AvailableProviders = exports.AvailableProviders || (exports.AvailableProviders = {}));
    function _normalizeConfiguration(configuration) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof configuration === "string")) return [3 /*break*/, 3];
                        if (!(configuration.indexOf("/") >= 0 &&
                            configuration.indexOf("Provider") < 0 &&
                            configuration[0] !== "{")) return [3 /*break*/, 2];
                        configuration = require(configuration);
                        return [4 /*yield*/, _normalizeConfiguration(configuration)];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [2 /*return*/, configuration];
                }
            });
        });
    }
    exports._normalizeConfiguration = _normalizeConfiguration;
});
})();