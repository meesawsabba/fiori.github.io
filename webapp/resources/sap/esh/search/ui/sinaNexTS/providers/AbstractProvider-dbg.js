...
sap.ui.define(["require", "exports", "../sina/SinaObject"], function (require, exports, SinaObject_1) {
    ...
    var AbstractProvider = /** @class */ (function (_super) {
        __extends(AbstractProvider, _super);
        ...
        AbstractProvider.prototype.getDebugInfo = function () {
            return "ESH Search API Provider: " + this.id;
        };
        // logUserEvent(event: any): void {
        //     return;
        // }
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        AbstractProvider.prototype.isQueryPropertySupported = function (path) {
            // currently only implemented in abap odata provider
            return false;
        };
        AbstractProvider.prototype.resetPersonalizedSearchDataAsync = function (
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        config) {
