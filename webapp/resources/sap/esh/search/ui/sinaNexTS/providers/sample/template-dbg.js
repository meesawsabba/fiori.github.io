 ...
 */
sap.ui.define(["require", "exports", "../../sina/NavigationTarget", "./template_metadata", "./template_details_folklorists", "./template_details_legends", "./template_details_publications"], function (require, exports, NavigationTarget_1, template_metadata_1, template_details_folklorists_1, template_details_legends_1, template_details_publications_1) {
    "use strict";
    ...
    function createTemplate(oContext) {
        ...
        if (oContext.sina) {
            ...
            gen.metadata = template_metadata_1.createTemplateMetadata(oContext).metadata;
            //metadata for legends
            gen.metadata2 = template_metadata_1.createTemplateMetadata(oContext).metadata2;
            //metadata for legends
            gen.metadata3 = template_metadata_1.createTemplateMetadata(oContext).metadata3;
        }
        if (oContext.searchQuery &&
            oContext.searchQuery.filter &&
            oContext.searchQuery.filter.dataSource &&
            oContext.sina &&
            oContext.sina.getDataSource("Folklorists")) {
            /*
             *
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).george;
            /*
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).shira;
            gen.searchResultSetItemArray.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Folklorists"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).benjamin;
            gen.searchResultSetItemArray.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Folklorists"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).richard;
            gen.searchResultSetItemArray.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Folklorists"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).rosalie;
            gen.searchResultSetItemArray.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Folklorists"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_folklorists_1.createTemplateDetails(oContext, gen).bill;
            gen.searchResultSetItemArray.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Folklorists"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).alligator;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                ...
                titleDescriptionAttributes: [],
                detailAttributes: detailAttributes,
                defaultNavigationTarget: new NavigationTarget_1.NavigationTarget({
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).slenderman;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Urban_Legends"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).chupacabra;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Urban_Legends"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).hitchhiker;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Urban_Legends"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).hitchhiker2;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Urban_Legends"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_legends_1.createTemplateDetails(oContext, gen).babytrain;
            gen.searchResultSetItemArray2.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Urban_Legends"),
                titleAttributes: titleAttributes,
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).alligatorbook;
            //if (addTestCaseSuvs) {
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).slendermanbook;
            // if (addTestCaseSuvs) {
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).chupacabrabook;
            //if (addTestCaseSuvs) {
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).hitchhikerbook;
            oContext.addSuvLinkToSearchResultItem(detailAttributes[0], null, searchTermsArray);
            gen.searchResultSetItemArray3.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Publications"),
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).hitchhiker2book;
            oContext.addSuvLinkToSearchResultItem(detailAttributes[0], null, searchTermsArray);
            gen.searchResultSetItemArray3.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Publications"),
            ...
            detailAttributes = template_details_publications_1.createTemplateDetails(oContext, gen).babytrainbook;
            oContext.addSuvLinkToSearchResultItem(detailAttributes[0], null, searchTermsArray);
            gen.searchResultSetItemArray3.push(oContext.sina._createSearchResultSetItem({
                attributes: [],
                dataSource: oContext.sina.getDataSource("Publications"),
