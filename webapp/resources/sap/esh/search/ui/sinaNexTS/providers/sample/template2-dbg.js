 ...
 */
sap.ui.define(["require", "exports", "../../sina/NavigationTarget", "../../sina/AttributeFormatType"], function (require, exports, NavigationTarget_1, AttributeFormatType_1) {
    "use strict";
    ...
    function createTemplate(oContext) {
        ...
        if (oContext.searchQuery &&
            ...
            oContext.sina &&
            oContext.sina.getDataSource("Scientists")) {
            /*
             *
