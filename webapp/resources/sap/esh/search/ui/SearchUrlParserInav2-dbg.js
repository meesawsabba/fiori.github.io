 ...
 */
sap.ui.define(["./i18n", "./SearchHelper", "./error/errors", "sap/m/MessageBox"], 
/**
 *
 * @param {*} i18n
 * @param {*} SearchHelper
 ...
 * @param {*} MessageBox
 */
function (i18n, SearchHelper, errors, MessageBox) {
    "use strict";
    ...
    SearchInav2UrlParser.prototype = {
        ...
        parseUrlParameters: function (oParametersLowerCased) {
            ...
            return this.model.sinaNext.loadMetadata(dataSource).then(function () {
                // root condition
                var context = {
