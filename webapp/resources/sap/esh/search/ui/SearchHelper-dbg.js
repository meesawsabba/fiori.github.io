 ...
 */
function (i18n, MessageBox, NumberFormat, FileSizeFormat) {
    "use strict";
    var module = {};
    // =======================================================================
    // Regex Tester
            ...
            $d.find("b").each(function () {
                ...
                if (positionOfHighlightedText + widthOfHighlightedText > widthOfCell) {
                    ...
                    if (widthOfHighlightedText > widthOfCell) {
                        ...
                        var lastWord;
                        var textBeforeHighlightedText = domref.innerHTML
                            .substring(0, indexOfHightlightedText)
                            .trim();
                        ...
                        while (textBeforeHighlightedText.length > 0) {
                            ...
                            if (domref.scrollWidth < widthOfCell) {
                                ...
                                textBeforeHighlightedText = textBeforeHighlightedText
                                    .substring(0, textBeforeHighlightedText.length - lastWord[0].length)
                                    .trim();
                            }
                            else {
                                while (domref.scrollWidth > widthOfCell &&
                                    previousTrimmedTexts.length > 0) {
    ...
    module.getUrlParameters = function () {
        var urlParameters = module.parseUrlParameters(module.getHashFromUrl());
    ...
    module.parseUrlParameters = function (unescapedSearchUrl) {
        ...
        for (var j = 0; j < knownSearchUrlParameters.length; j++) {
            if (knownSearchUrlParameters[j].pos !== -1) {
                ...
                oParametersLowerCased[knownSearchUrlParameters[j].name] =
                    knownSearchUrlParameters[j].value;
            }
        }
    ...
    module.hasher = {
        ...
        setHash: function (hash) {
            ...
            if (window.decodeURIComponent(module.getHashFromUrl()) !== window.decodeURIComponent(hash)) {
                try {
        ...
        hasChanged: function () {
            if (window.decodeURIComponent(this.hash) !==
                window.decodeURIComponent(module.getHashFromUrl())) {
                return true;
            }
            return false;
        },
    ...
    module.SearchFocusHandler.prototype = {
        ...
        get2BeFocusedControlDomRef: function () {
            ...
            if (this.oModel.getDataSource() !== this.oModel.appDataSource) {
                ...
                if (this.oModel.getProperty("/boCount") > 0 && this.oModel.getProperty("/appCount") > 0) {
                    ...
                    control = this.oSearchComposite.resultList.getItems()[index];
                    if (control && control.getDomRef) {
                        controlDomRef = control.getDomRef();
                    }
                }
                else if (this.oModel.getProperty("/boCount") > 0 &&
                    ...
                    isGridDisplayed = this.oModel.getResultToDisplay() === "searchResultGrid";
                    ...
                    if (isListDisplayed) {
                        ...
                        // 1.2.3 grid view
                        if (this.oSearchComposite.searchResultGrid.mAggregations.items) {
                            control = this.oSearchComposite.searchResultGrid.getItems()[index];
                        }
                        else if (this.oSearchComposite.searchResultGrid.mAggregations.content) {
                    ...
                    this.oModel.getProperty("/appCount") > 0) {
                    // 1.3 only apps
                    control = this.oSearchComposite.resultList.getItems()[0];
                ...
                if (module._isDisplayed(tileDOM)) {
                    controlDomRef = module.getFocusableTileDomRef(tileDOM.getDomRef());
                }
            }
        ...
        setFocus: function () {
            ...
            if (!meButton.isDecorated) {
                ...
                that.oSearchComposite.resultList.collectListItemsForNavigation();
            };
    ...
    module.formatInteger = function (value) {
        ...
        if (!module._integerShortFormatter) {
            module._integerShortFormatter = NumberFormat.getIntegerInstance({
                style: "short",
                precision: 3,
        ...
        if (!module._integerStandardFormatter) {
            module._integerStandardFormatter = NumberFormat.getIntegerInstance({
                style: "standard",
                precision: 3,
                groupingEnabled: true,
            }, sap.ui.getCore().getConfiguration().getLocale());
    ...
    module.formatFileSize = function (value) {
        ...
        if (!module._fileSizeFormatter) {
            module._fileSizeFormatter = FileSizeFormat.getInstance({
                style: "short",
                precision: 3,
                groupingEnabled: true,
                binaryFilesize: true,
    ...
    module.attachEventHandlersForTooltip = function (element) {
        var $element = $(element);
        $element
            .find(".sapUshellSearchResultListItem-MightOverflow")
    ...
    // =======================================================================
    module.convertJQueryDeferredToPromise = function (deferred) {
        if (deferred.always) {
