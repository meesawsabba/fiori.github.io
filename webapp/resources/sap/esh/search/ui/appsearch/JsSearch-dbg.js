        ...
        if (Array.isArray(options.fields)) {
            ...
            if (Array.isArray(options.fields.groups)) {
                ...
                options.fields.groups.forEach(function (g, i) {
                    var weight = ((options.fields.groups.length - 1 - i) / (options.fields.groups.length - 1)) *
                        (scale - 1) +
                        1;
                    if (Array.isArray(g)) {
                    ...
                    compileSearchTerm: function (searchTerm) {
                        ...
                        var compiledRegExps = st.parsed.map(function (s) {
                            ...
                            if (s.type === "phrase") {
                                ...
                                /** @param {number} i */
                                function (y, i) {
                                    return ((i !== 0 && i !== s.children.length - 1) ||
                                        !y.wOriginal.match(/^\*+$/));
                                });
                                    ...
                                    function (word, i, pre, succ) {
                                        if (word.wOriginal !== "*") {
                                            ...
                                            if (i !== 0 &&
                                                ...
                                                if (!(pre.wOriginal.match(regExps.Alpha_atEnd) &&
                                        ...
                                        else if (lastCharacterOriginal(pre).match(regExps.Alpha_atBegin) &&
                                            firstCharacterOriginal(succ).match(regExps.Alpha_atBegin)) {
                                            //  letter * letter
                                            middle += "(?:[^a]|[^a].*?[^a])";
                                        }
                                        else if (lastCharacterOriginal(pre).match(regExps.Num_atEnd) &&
                                        ...
                                        else if (lastCharacterOriginal(pre) === "*" &&
                                            succ &&
                                            firstCharacterOriginal(succ).match(regExps.Alpha_atBegin)) {
                                            //  xxx* * letter
                                            middle += ".*?";
