...
sap.ui.define([], function () {
    ...
    var tokenClasses = [
        module.WhitespaceToken,
        module.MatchStartToken,
        module.MatchEndToken,
        module.HashToken,
        module.UserToken,
        module.SpecialCharactersTextToken,
        module.TextToken,
    ];
    var tokenClassMap = {};
            ...
            switch (tokens.length) {
                ...
                case 1:
                    ...
                    if (resultToken._match) {
                        resultToken.matches = [[resultToken.startIndex, resultToken.endIndex]];
                    }
                    return resultToken;
                default:
    ...
    module.TwitterUserNode.prototype = {
        ...
        render: function (oRm) {
            oRm.write('<a target="_blank" rel="noopener noreferrer" class="sapMLnk sapUshellSearchTwitterInline" href="https://twitter.com/' +
                this.user +
                '">');
    ...
    module.TwitterHashNode.prototype = {
        ...
        render: function (oRm) {
            oRm.write('<a target="_blank" rel="noopener noreferrer" class="sapMLnk sapUshellSearchTwitterInline" href="https://twitter.com/hashtag/' +
                this.tag +
                '?src=hash">');
    ...
    module.TwitterLinkNode.prototype = {
        ...
        render: function () {
            /*oRm.write('<a target="_blank" class="sapMLnk sapUshellSearchTwitterInline" href="' + this.url + '">');
