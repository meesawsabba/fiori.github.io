...
], function (i18n, SearchResultListItem, SearchText, SearchHelper, Icon, IconPool, DateFormat) {
    "use strict";
    var noValue = "\u2013"; // dash
    return SearchResultListItem.extend("sap.esh.search.ui.controls.SearchResultListItemDocument", {
            ...
            if (that.getContainsThumbnail() === true) {
                ...
                if (that.getContainsSuvFile() === true) {
                    var pressHandler = function () {
                        window.open(that.getSuvlink(), "_blank", "noopener,noreferrer");
                    };
                ...
                if (that.getContainsSuvFile() === true) {
                    oRm.write('<a target="_blank" href="' + that.getSuvlink() + '" rel="noopener noreferrer">');
                }
                else {
                    oRm.write('<a target="_blank" rel="noopener noreferrer">');
                }
        ...
        hideDetails: function () {
            ...
            var attributeHeight = resultListItem
