 ...
 * @param {*} PlacementType
 */
function (i18n, SearchFacetPieChart, Log, ComparisonMicroChart, Label, IconTabFilter, Button, Bar, BarDesign, Filter, FilterOperator, ResizeHandler, ComparisonMicroChartData, ValueColor, ActionSheet, PlacementType) {
    "use strict";
    var module = {};
    jQuery.extend(module, {
        ...
        getBarChartPlaceholder: function () {
            var that = this;
            var oChart1;
            oChart1 = new ComparisonMicroChart({
                height: "90%",
                width: "100%",
                colorPalette: "",
                tooltip: "",
            ...
            var oBarchartFilter1 = new Filter("value", FilterOperator.GT, 0);
            var oBindingInfo2 = {
                path: "items",
                factory: function () {
        ...
        testWhetherPieWedgeOrLabelIsDummy: function (oEvent) {
            var res = false;
            var label = "";
            var possibleNumPerc = 0, possibleNumTop = 0;
            try {
                ...
                if (label ===
                    i18n.getText("facetPieChartOverflowText2", [possibleNumPerc, possibleNumTop])) {
                    res = true;
                }
                else if (label ===
                    i18n.getText("facetPieChartOverflowText2", [possibleNumTop, possibleNumPerc])) {
        ...
        getPieChartPlaceholder2: function () {
            ...
            var oPiechartFilter1 = new Filter("pieReady", FilterOperator.EQ, true);
        ...
        getHeaderWithDropDown: function (title) {
            ...
            var headerWithDropDown = new Bar({
                translucent: true,
            ...
            for (var i = 0; i < oControl.tabBarItems.length; i++) {
                oButton = new Button({
                    ...
                    press: function (oEvent) {
                        ...
                        buttonClickedIndex =
                            document.getElementById(buttonClickedId).dataset.facetViewIndex;
            ...
            for (var i = 0; i < searchFacetLargeChartContainer.length; i++) {
                if (searchFacetLargeChartContainer[i].clientHeight > 0) {
                    ...
                    relevantContainerHeight =
                        searchFacetLargeChartContainer[i].offsetParent.offsetParent.offsetParent
                            .clientHeight;
