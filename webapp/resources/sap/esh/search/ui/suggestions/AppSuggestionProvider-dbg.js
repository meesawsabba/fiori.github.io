...
sap.ui.define([
    ...
    "sap/esh/search/ui/suggestions/SuggestionProvider",
 ...
 */
function (i18n, SearchHelper, SuggestionProvider, SuggestionType) {
    "use strict";
    // =======================================================================
    ...
    module.prototype = jQuery.extend(new SuggestionProvider(), {
        ...
        getSuggestions: function () {
            ...
            if (dataSource !== that.model.allDataSource && dataSource !== that.model.appDataSource) {
                return Promise.resolve([]);
            }
            // get suggestions
            var suggestionTerm = that.model.getProperty("/uiFilter/searchTerm");
            return that.suggestApplications(suggestionTerm).then(function (resultset) {
                ...
                if (resultset.totalResults > appSuggestionLimit &&
