...
sap.ui.define([
	 ...
	 */
	var VariantContent = {};
	VariantContent.applyChange = function(oChange, oPersoControl, mPropertyBag) {
		...
		var oVariantManagement = oPersoControl.getVariantManagement ? oPersoControl.getVariantManagement() : oPersoControl;
		...
		if (oVariantManagement.isA("sap.ui.comp.smartvariants.SmartVariantManagement")) {
			...
			if ((oVariantManagement.getSelectionKey() === oChangeContent.key)) {
				...
				oVariantManagement.assignShadowContent(oChangeContent.key, oControlContent);
			}
		}
	};
	...
	VariantContent.revertChange = function(oChange, oPersoControl, mPropertyBag) {
