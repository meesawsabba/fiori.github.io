...
sap.ui.define([
	...
	HistoryValuesProvider.prototype.attachChangeListener = function () {
		...
		if (this._oControl.isA("sap.m.Input")) {
			this._oControl.attachChange(this._onInputChange, this);
			return;
		}
	...
	HistoryValuesProvider.prototype._detachChangeListener = function () {
		...
		if (this._oControl.isA("sap.m.Input")) {
			this._oControl.detachChange(this._onInputChange, this);
			return;
		}
	...
	HistoryValuesProvider.prototype._onInputChange = function (oEvent) {
