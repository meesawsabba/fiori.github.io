...
sap.ui.define(['sap/ui/core/Core', 'sap/ui/core/library', 'sap/m/library'], function(Core, library1, library2) {
	 ...
	 * @ui5-metamodel This enumeration will also be described in the UI5 (legacy) design time meta model.
	 */
	sap.ui.comp.filterbar.FilterBar.AdaptFiltersView = {

		/**
		 * Group mode for the Adapt Filters Dialog. This mode is used to display the items within the Adapt Filters Dialog
		 * as groups.
		 *
		 * @private
		 */
