...
// -----------------------------------------------------------------------------
sap.ui.define([
	'./ODataType', 'sap/ui/comp/odata/FiscalMetadata', 'sap/ui/model/odata/AnnotationHelper', 'sap/base/Log'
], function(ODataType, FiscalMetadata, AnnotationHelper, Log) {
	"use strict";
	 ...
	 MetadataAnalyser.prototype.getODataRelevantValueLists = function(oPropertyContext, oBindingContext) {
		return this._oMetaModel.getODataValueLists(oPropertyContext).then(function(oValueList){
			...
			for (sQualifier in oValueList) {
				...
				if ((bHasValueListRelevantQualifiers && aRelevantQualifiers.indexOf(sQualifier) !== -1) || sQualifier === sPrimaryAnnotationKey) {
