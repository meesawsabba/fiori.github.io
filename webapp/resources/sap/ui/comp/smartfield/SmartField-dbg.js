...
sap.ui.define([
	...
	var SmartField = Control.extend("sap.ui.comp.smartfield.SmartField", /** @lends sap.ui.comp.smartfield.SmartField.prototype */ {
		...
		renderer: {
			...
			render: function(oRm, oControl) {
				...
				&& oControl.getInnerControls()[0] && !oControl.getInnerControls()[0].isA("sap.m.Text")){
					oRm.openStart("span");
	...
	SmartField.prototype.init = function() {
		this._isInnerControlCreationDelayed = false;
		this._sAnnotationLabel = "";
		this._bInDestroy = false;
		this._oSideEffects = new SideEffectUtil(this);
		this._oFactory = null;

		// Takes care of the internal flag of the SmartField which shows if the control value has changed from the
		// initial one due to user interaction.
	...
	SmartField.prototype.onBeforeRendering = function() {
		...
		if (this.isContextTable() && oUoMNestedSmartField){
			this._handleUoMAriaLabelledByInSmartTable(oUoMNestedSmartField);
	...
	/**
	 * Handles AriaLabelledBy for UoM SmartField inside of a SmartTable
	 * @private
	 * @param {object} oUoMNestedSmartField Currency field from UoM pair
	 */
	SmartField.prototype._handleUoMAriaLabelledByInSmartTable = function(oUoMNestedSmartField) {
	...
	/**
	 * Has the initial value of the SmartField changed by user interaction
	 * @private
	 * @returns {boolean}
	 */
	SmartField.prototype._isValueInitial = function () {
		return !this._bValueNotInitial;
	};
