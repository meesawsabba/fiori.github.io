...
sap.ui.define([
	...
	ColumnsController.prototype.retrieveAdaptationUI = function(oPayload) {
		return new Promise(function(resolve){
			sap.ui.require([
				'sap/ui/mdc/p13n/panels/ListView', 'sap/m/Column'
			], function(ListView, Column) {

				var oAdaptationModel = this.getAdaptationModel();
				...
				oSelectionPanel.setPanelColumns([sap.ui.getCore().getLibraryResourceBundle("sap.ui.mdc").getText("fieldsui.COLUMNS"), new Column({
					width: "25%",
					hAlign: "Center",
					vAlign: "Middle"
				})]);
				...
				oSelectionPanel.attachChange(function(oChangeEvt){
					aMapped = oChangeEvt.getSource().getP13nModel().getProperty("/items").map(function(oP13nItem, iIndex){
						return {
