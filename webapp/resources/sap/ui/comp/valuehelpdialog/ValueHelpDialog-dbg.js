...
sap.ui.define([
		...
		switch (newViewMode) {
			...
			case _ValueHelpViewMode.PHONE_LIST_VIEW:
				...
				if (this._bIsMdcCollectiveSearch) {
					...
					this._oColSearchBox.oText.removeStyleClass("sapUiMdcCollectiveSearchSelectTextPhoneMaxWidth");
				}
	...
	ValueHelpDialog.prototype._registerResizeHandler = function() {
		Dialog.prototype._registerResizeHandler.apply(this, arguments);
		ResizeHandler.register(this, this._onResize.bind(this));
	};

	ValueHelpDialog.prototype._onResize = function() {
		Dialog.prototype._onResize.apply(this, arguments);
		this._setToolbarSpacerWidth();
	};
