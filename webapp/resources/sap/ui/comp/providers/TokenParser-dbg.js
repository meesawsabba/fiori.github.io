...
sap.ui.define([
	...
	function(library, ManagedObject, Token, mLibrary, FormatUtil) {
		...
		TokenParser.prototype._init = function() {
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.Empty]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.BT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.EQ]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.Contains]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.StartsWith]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.EndsWith]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.LT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.LE]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.GT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.GE]);

			// Exclude operations
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotEmpty]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotBT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotEQ]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotContains]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotStartsWith]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotEndsWith]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotLT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotLE]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotGT]);
			this.createOperation(TokenParser.rangeOperations[P13nConditionOperation.NotGE]);
		};
