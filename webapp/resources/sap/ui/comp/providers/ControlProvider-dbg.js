...
sap.ui.define([
	...
	ControlProvider.prototype._createFieldMetadata = function(oFieldODataMetadata) {
		...
		//Note: Consider to implement this fallback in the control itself as the consumer can't distinguish if it's a fallback or annotated
