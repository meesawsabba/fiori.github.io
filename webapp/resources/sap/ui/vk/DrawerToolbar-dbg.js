...
sap.ui.define([
	...
	DrawerToolbar.prototype.createButtons = function() {
		...
		crossSectionButton = new ToggleButton({
			...
			tooltip: getResourceBundle().getText("CROSS_SECTION_TOOLTIP"),
			press: function(event) {
		...
		crossSectionAxis = new MenuButton({
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("CROSS_SECTION_AXIS_TOOLTIP"),
		...
		var turntable = new ToggleButton({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("TURNTABLE_TOOLTIP"),
			press: function(event) {
				var viewport = that._getViewport();
				if (viewport) {
		...
		var orbit = new ToggleButton({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("ORBIT_TOOLTIP"),
			pressed: false,
			press: function(event) {
				var viewport = that._getViewport();
				if (viewport) {
		...
		var pan = new ToggleButton({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("PAN_TOOLTIP"),
			press: function(event) {
				var viewport = that._getViewport();
				if (viewport) {
		...
		var zoom = new ToggleButton({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("ZOOM_TOOLTIP"),
			press: function() {
				var viewport = that._getViewport();
				if (viewport) {
		...
		var show = new Button({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("SHOW_TOOLTIP"),
			press: function() {
		...
		var hide = new Button({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("HIDE_TOOLTIP"),
			press: function() {
				var vsm = that._getViewStateManager();
				if (vsm) {
					var selected = [];
		...
		this._rectSelectionButton = new ToggleButton({
			...
			type: sap.m.ButtonType.Transparent,
			tooltip: getResourceBundle().getText("RECTANGULAR_SELECTION_TOOLTIP")
		});
