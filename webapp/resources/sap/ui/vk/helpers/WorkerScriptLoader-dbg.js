...
sap.ui.define([
	...
	WorkerScriptLoader.loadScript = function(workerScriptUrl, additionalScripts) {
		...
		if (sap.ui.Device.browser.internet_explorer) {
			...
			scriptList.push("'" + this.absoluteUri("sap/ui/thirdparty/es6-promise.js") + "'");
			scriptList.push("'" + this.absoluteUri("sap/ui/thirdparty/es6-string-methods.js") + "'");
			scriptList.push("'" + this.absoluteUri("sap/ui/vk/thirdparty/ie-polyfills.js") + "'");
		}
