...
sap.ui.define([
	 ...
	 * @param {AnimationTrackType} type property type (translate, scale, quaterninon, opacity)
	...
	AnimationPlayback.prototype._setCurrentNodesPropertiesAsBoundary = function(viewStateManager, isEnd, forced) {
		if (!forced && ((this._nodeEndPropertiesMap && this._nodeEndPropertiesMap.size && isEnd) ||
