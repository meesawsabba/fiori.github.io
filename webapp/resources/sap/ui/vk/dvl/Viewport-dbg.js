...
sap.ui.define([
	...
	Viewport.prototype.hitTest = function(x, y) {
		if (this._dvlRendererId) {
			var result = this._dvl.Renderer.HitTest(x * window.devicePixelRatio * this._gestureRatio, y * window.devicePixelRatio * this._gestureRatio, this._dvlRendererId).id;
	...
	Viewport.prototype.beginGesture = function(x, y) {
		if (this._dvlRendererId) {
			...
			this._dvl.Renderer.BeginGesture(x * window.devicePixelRatio * this._gestureRatio, y * window.devicePixelRatio * this._gestureRatio, this._dvlRendererId);
		}
		return this;
	};
	...
	Viewport.prototype.tap = function(x, y, isDoubleClick) {
		if (this._dvlRendererId) {
			var px = x * window.devicePixelRatio * this._gestureRatio, py = y * window.devicePixelRatio * this._gestureRatio;
			if (!isDoubleClick) {
