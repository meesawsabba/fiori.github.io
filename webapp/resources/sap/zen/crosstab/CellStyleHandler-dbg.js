...
sap.ui.define(
  ...
  function(RenderingConstants, Utils){
    "use strict";
    sap.zen.crosstab.CellStyleHandler = {};
    ...
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_BACKGROUND] = "Background";
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_FONT_COLOR] = "FontColor";
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_STATUS_SYMBOL] = "StatusSymbol";
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_TREND_ASCENDING_SYMBOL] = "TrendAscendingSymbol";
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_TREND_DESCENDING_SYMBOL] = "TrendDescendingSymbol";
    sap.zen.crosstab.CellStyleHandler.oExceptionVisualizationMapping[RenderingConstants.ALERT_TYPE_TREND_GREY_SYMBOL] = "TrendGreySymbol";
    sap.zen.crosstab.CellStyleHandler.getCompleteStyleName = function(sStyle, sCellType) {
      var sCompleteStyle = "";
      if (sCellType === RenderingConstants.TYPE_DATA_CELL) {
        sCompleteStyle = RenderingConstants.STYLE_PREFIX_DATA_CELL + sStyle;
      } else {
        sCompleteStyle =RenderingConstants.STYLE_PREFIX_HEADER_CELL + sStyle;
      }
    ...
    sap.zen.crosstab.CellStyleHandler.iDataCellAlternatingIndex = sap.zen.crosstab.CellStyleHandler.pushPresetStyle(RenderingConstants.STYLE_ALTERNATING, RenderingConstants.TYPE_DATA_CELL);
    sap.zen.crosstab.CellStyleHandler.iHeaderCellAlternatingIndex = sap.zen.crosstab.CellStyleHandler.pushPresetStyle(RenderingConstants.STYLE_ALTERNATING, RenderingConstants.TYPE_HEADER_CELL);
