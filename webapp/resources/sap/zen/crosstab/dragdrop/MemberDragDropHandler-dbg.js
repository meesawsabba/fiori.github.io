...
sap.ui.define(
  ...
  function(jQuery) {
    ...
    sap.zen.crosstab.dragdrop.MemberDragDropHandler = function (oCrosstab, oDragDropCommands, oDragDropUtils, oDragDropAreaRenderer, oDragDropHoverManager) {
      ...
      function memberCellDraggableHelper() {
        var oCell;
        var oDragCell;
        var oHeaderInfo;
        var aDragCells;
        ...
        if (oCell) {
          oDragDropUtils.setCurrentJqDragCell(jQuery(document.getElementById(oCell.getId())));
          if (bIsRepeatTexts) {
      ...
      function checkMemberCellDropAccept(oDraggable) {
        ...
        oDropCell = oDragDropHoverManager.getCellFromJqCell(jQuery(this));
      ...
      function handleDropAreaDrop(e, ui) {
        ...
        if (oDragDropUtils.checkDropAllowedOnCrosstabElement(e)) {
          ...
          oAnchorCell = sap.ui.getCore().getControl(jQuery(this).data("xtabcellid"));
          oDragCell = oDragDropUtils.getCrosstabHeaderCellFromDraggable(jQuery(ui.draggable));
          oDragCell = oDragDropUtils.getEffectiveCell(oDragCell);

          sAreaType = oDragDropUtils.getDropAreaTypeFromDropAreaId(jQuery(this).attr("id"));
