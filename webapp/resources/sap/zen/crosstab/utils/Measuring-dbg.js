  ...
  function(jQuery) {
    ...
    sap.zen.crosstab.utils.Measuring = function (oCrosstab, oDomElementProvider) {
      ...
      this.getUpperLeftScrollDivWidth = function() {
        var oJqDiv = jQuery(document.getElementById(oCrosstab.getId() + "_upperLeft_scrollDiv"));
        return oJqDiv.outerWidth();
      };

      this.getLowerLeftScrollDivWidth = function() {
        var oJqDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerLeft_scrollDiv"));
        return oJqDiv.outerWidth();
      };

      this.getAreaWidth = function (oArea) {
        var oJqArea = jQuery(document.getElementById(oArea.getId() + "_container"));
      ...
      this.getAreaHeight = function (oArea) {
        var oDomArea = jQuery(document.getElementById(oArea.getId() + "_container"));
      ...
      this.getRenderSizeDivSize = function () {
        ...
        var oDomRenderSizeDiv = jQuery(document.getElementById(oCrosstab.getId() + "_renderSizeDiv"));
      ...
      this.getLowerScrollDivHeight = function () {
        ...
        if (oRowHeaderArea.hasContent()) {
          oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerLeft_scrollDiv"));
        } else {
          oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerRight_scrollDiv"));
        }
      ...
      this.getUpperScrollDivHeight = function () {
        ...
        if (oDimensionHeaderArea.hasContent()) {
          oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_upperLeft_scrollDiv"));
        } else {
          oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_upperRight_scrollDiv"));
        }
        return oDomScrollDiv.outerHeight();
      };

      this.getUpperRightScrollDivWidth = function () {
        var oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_upperRight_scrollDiv"));
      ...
      this.getRenderSizeDivBorders = function (oDomRenderSizeDiv) {
        if (!oRenderSizeDivBorders) {
          ...
          if (!oDomRenderSizeDiv) {
            oDomRenderSizeDiv = jQuery(document.getElementById(oCrosstab.getId() + "_renderSizeDiv"));
          }
          oRenderSizeDivBorders.borders.iBottomBorderWidth = parseInt(
