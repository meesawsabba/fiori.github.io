  ...
  function(jQuery,Utils) {
    ...
    sap.zen.crosstab.HeaderResizer = function (oCrosstab) {
      ...
      this.attachEvents = function() {
        var oResizeHandle = jQuery(document.getElementById(oCrosstab.getId() + "_headerResizeHandle"));
      ...
      this.onMouseUp = function(e) {
        ...
        jQuery(document).unbind("mouseup", that.handleMouseUpHeaderResizeHandle);
        Utils.cancelEvent(e);
      };
      ...
      this.onMouseDown = function(e) {
        oJqResizeHandle = jQuery(e.currentTarget);
        ...
        jQuery(document).on("mouseup", that.handleMouseUpHeaderResizeHandle);
        Utils.cancelEvent(e);
      };
