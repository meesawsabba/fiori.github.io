  ...
  [
    ...
    sap.zen.crosstab.ColResizer = function (oCrosstab) {
      ...
      this.initialize = function() {
        ...
        oJqResizeRuler = jQuery(document.getElementById(oCrosstab.getId() + "_colResizeRuler"));
        this.attachEvents();
      };
      /**
       * attachEvents
      ...
      this.attachEvents = function() {
        ...
        jQuery.each(aResizers, function(iIndex, oDomResizer) {
          var oJqResizer = jQuery(oDomResizer);
      ...
      this.onMouseUp = function(e) {
        ...
        if (oResizeCell && oResizeCellRect) {
          ...
          bRulerVisible = false;
          jQuery(document).off("mouseup", that.onMouseUp);
      ...
      this.onMouseDown = function(e) {
        if (!oResizeCell) {
          ...
          if (oResizeCell) {
            ...
            jQuery(document).on("mouseup", that.onMouseUp);
            // handled
            Utils.cancelEvent(e);
          }
        }
