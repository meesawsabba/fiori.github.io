  ...
  function(jQuery, RenderingConstants, Utils){
    ...
    sap.zen.crosstab.CrosstabRenderer.render = function (oRenderManager, oControl) {
      ...
      if (oControl.getRenderMode() === RenderingConstants.RENDERMODE_COMPACT) {
        rm.write("<div");
        rm.writeAttributeEscaped("id", oControl.getId() + "_altRenderModeTableDiv");
        rm.addStyle("visibility", "hidden");
        rm.addStyle("width", "100%");
        rm.addStyle("height", "100%");
        rm.writeAttributeEscaped("class", "sapzencrosstab-TableDiv sapzencrosstab-TableDivBackground");
        rm.writeStyles();
        rm.write(">");
      }
      rm.write("<div");
      rm.writeAttributeEscaped("id", oControl.getId() + "_renderSizeDiv");
      rm.writeAttribute("class", "sapzencrosstab-RenderSizeDiv");
      rm.write(">");

      rm.write("<table");
      rm.writeAttributeEscaped("id", oControl.getId() + "_table");
      rm.writeAttribute("class", "sapzencrosstab-Crosstab");
      rm.write(">"); // table element

      // first row
      rm.write("<tr");
      rm.writeAttributeEscaped("id", oControl.getId() + "_upperSection");
      rm.write(">");
      ...
      // second row
      rm.write("<tr");
      rm.writeAttributeEscaped("id", oControl.getId() + "_lowerSection");
      rm.write(">");
      ...
      if (oControl.getPropertyBag().hasToolbar()) {
        rm.write("<div");
        rm.writeAttributeEscaped("id", oControl.getId() + "_toolbar");
        rm.writeAttributeEscaped("class", "sapzencrosstab-ToolbarDiv");
