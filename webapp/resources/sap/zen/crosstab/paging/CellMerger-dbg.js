...
sap.ui.define(
  ...
  function(jQuery, PagingConstants){
    "use strict";
    ...
    sap.zen.crosstab.paging.CellMerger = function (oPageManager) {
      ...
      function mergeCellWithUpperPages (oMergeCell, iPagePosRow, iCol) {
        ...
        while (iStatus === PagingConstants.PAGE_STATUS_LOADED && iCurrentPagePosRow >= 0 && !oUpperMergeCell) {
      ...
      function mergeCellWithLowerPage (oMergeCell, iPagePosRow, iCol) {
        ...
        if (iStatus === PagingConstants.PAGE_STATUS_LOADED) {
      ...
      function mergeCellWithLeftPages (oMergeCell, iPagePosCol, iRow) {
        ...
        while (iStatus === PagingConstants.PAGE_STATUS_LOADED && iCurrentPagePosCol >= 0 && !oLeftMergeCell) {
