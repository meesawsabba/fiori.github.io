  ...
  function(jQuery){
    ...
    sap.zen.crosstab.paging.RequestStack = function(iMaxSize) {
      ...
      this.push = function(oElement) {
        ...
        var iAlreadyContainedIndex = jQuery.inArray(oElement, aElements);
      ...
      this.containsElement = function(oElement) {
        return (jQuery.inArray(oElement, aElements) != -1);
      };
      ...
      this.removeElementRemovedHandler = function(fHandler) {
        var iIndex = jQuery.inArray(fHandler, aElementRemovedHandlers);
        if (iIndex !== -1) {
