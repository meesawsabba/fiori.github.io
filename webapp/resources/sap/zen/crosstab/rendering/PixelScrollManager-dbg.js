  ...
  function(jQuery) {
    ...
    sap.zen.crosstab.rendering.PixelScrollManager = function (oCrosstab, oRenderEngine) {
      ...
      function getDomScrollDiv (sScrollDivSuffix) {
        ...
        if (!oDomScrollDiv) {
          oDomScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + sScrollDivSuffix));
      ...
      function moveVScrollbar (iPos) {
        ...
        var oDomLowerLeftScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerLeft_scrollDiv"));
      ...
      this.positionVScrollDiv = function () {
