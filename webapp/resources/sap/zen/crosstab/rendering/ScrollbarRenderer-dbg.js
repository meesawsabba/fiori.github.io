...
sap.ui.define(
  ...
  function(jQuery, Measuring, Utils) {
    "use strict";
    ...
    sap.zen.crosstab.rendering.ScrollbarRenderer = function (oCrosstab, oRenderManager, oMeasuring, oDomElementProvider) {
      ...
      function writeUpperVScrollCellContent (iUpperAreaHeight) {
        ...
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_upperRightPad");
      ...
      function writeLowerVScrollCellContent (iScrollDivHeight, iUpperAreaHeight) {
        ...
        if (bHHeaderScrollbarVisible === true && !bHScrollbarVisible) {
          iInitialHeight = jQuery(document.getElementById(oCrosstab.getId() + "_renderSizeDiv")).outerHeight() - iScrollbarWidth;
        } else {
      ...
      function renderVScrollbarTable (iScrollDivHeight) {
        ...
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_vScrollTab");
      ...
      function renderVScrollbarSection () {
        ...
        oRenderManager.write("<div");
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_vScrollDiv");
      ...
      function getLeftScrollDivWidth() {
        var iWidth = 0;
        var oDiv = jQuery(document.getElementById(oCrosstab.getId() + "_upperLeft_scrollDiv"));
        ...
        if (iWidth === 0) {
          oDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerLeft_scrollDiv"));
          iWidth = oUtils.isMsIE() || (oProp.isRtl() && oUtils.isMozilla()) ? oDiv.width() : oDiv.outerWidth();
        }
        return iWidth;
      }
      ...
      function writeLeftHScrollCellContent (iLowerLeftAreaWidth) {
        if (!bHHeaderScrollbarVisible) {
          oRenderManager.write("<div");
          oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_lowerLeftPad");
      ...
      function beginHScrollTableCell (bHHeaderScrollbarVisible) {
        if (bHHeaderScrollbarVisible === true) {
          oRenderManager.write("<td");
          oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_hScrollTableCell");
      ...
      function writeRightHScrollCellContent () {
        oRenderManager.write("<div");
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_lowerRightPad");
      ...
      function writeMiddleHScrollCellContent (iScrollDivWidth, iLowerLeftAreaWidth) {
        if (bHScrollbarVisible === true) {
          ...
          // write a blank div
          oRenderManager.write("<div");
          oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_lowerMiddlePad");
      ...
      function renderHScrollbarTable() {
        var oDomLowerLeftArea = jQuery(document.getElementById(oCrosstab.getId() + "_lowerLeft"));
        var iLowerLeftAreaWidth = oDomLowerLeftArea.outerWidth();

        oRenderManager.write("<table");
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_hScrollTab");
      ...
      function renderHScrollbarSection () {
        ...
        oRenderManager.write("<div");
        oRenderManager.writeAttributeEscaped("id", oCrosstab.getId() + "_hScrollDiv");
      ...
      this.attachHandlers = function (poHScrollHandler, poVScrollHandler, poHeaderHScrollHandler) {
        ...
        if (oHScrollHandler && oCrosstab.getHScrollbar()) {
          ...
          oCrosstab.getHScrollbar().attachBrowserEvent(
        ...
        if (oVScrollHandler && oCrosstab.getVScrollbar()) {
          ...
          oCrosstab.getVScrollbar().attachBrowserEvent(
            "mousedown touchstart",
            Utils.cancelEvent
          );
        ...
        if (oHeaderHScrollHandler && oCrosstab.getHorizontalHeaderScrollbar()) {
          ...
          oCrosstab.getHorizontalHeaderScrollbar().attachBrowserEvent(
            "mousedown touchstart",
            Utils.cancelEvent
          );
        }
      ...
      this.detachHandlers = function () {
        if (oHScrollHandler && oCrosstab.getHScrollbar()) {
          ...
          oCrosstab.getHScrollbar().detachBrowserEvent(
            "mousedown touchstart",
            Utils.cancelEvent
          );
        }
        if (oVScrollHandler && oCrosstab.getVScrollbar()) {
          ...
          oCrosstab.getVScrollbar().detachBrowserEvent(
            "mousedown touchstart",
            Utils.cancelEvent
          );
        ...
        if (oHeaderHScrollHandler && oCrosstab.getHorizontalHeaderScrollbar()) {
          ...
          oCrosstab.getHorizontalHeaderScrollbar().detachBrowserEvent(
            "mousedown touchstart",
            Utils.cancelEvent
          );
        }
      ...
      this.setHorizontalHeaderScrollbarSteps = function() {
        ...
        if (oHeaderHScrollbar) {
          ...
          if (sDivId) {
            var oJqDiv = jQuery(document.getElementById(sDivId));
      ...
      this.adjustHorizontalHeaderScrollbarContainerSize = function() {
        ...
        if (oHHeaderScrollbar) {
          var oTd = jQuery(document.getElementById(oCrosstab.getId() + "_hScrollTableCell"));
          if (oTd.length > 0) {
      ...
      this.setScrollbarStepsInPixelMode = function () {
        ...
        var oDomDataArea = jQuery(document.getElementById(oCrosstab.getId() + "_dataArea_container"));
        if (oVScrollbar) {
          var iHeight = 0;
          if(!oCrosstab.hasDataArea()){
            ...
            var oDomRowHeaderArea = jQuery(document.getElementById(oCrosstab.getId() + "_rowHeaderArea_container"));
        ...
        if (oHScrollbar) {
          ...
          if(!oCrosstab.hasDataArea()){
            //Can happen in scenarios where there is no data area, but only a header area.
            //See customer message 0120025231 0000377482 2013
            var oDomColHeaderArea = jQuery(document.getElementById(oCrosstab.getId() + "_colHeaderArea_container"));
      ...
      this.adjustHScrollbarWidth = function(iScrollPadWidth){
        ...
        var oDomLowerRightScrollDiv = jQuery(document.getElementById(oCrosstab.getId() + "_lowerRight_scrollDiv"));
