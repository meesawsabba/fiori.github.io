...
sap.ui.define(
  [
    "jquery.sap.global",
    "sap/zen/crosstab/rendering/ScrollManager",
    "sap/zen/crosstab/rendering/PixelScrollManager",
    "sap/zen/crosstab/rendering/HeaderScrollManager",
    "sap/zen/crosstab/utils/Utils"
  ],
  function(jQuery,ScrollManager, PixelScrollManager, HeaderScrollManager){
    "use strict";
    ...
    sap.zen.crosstab.rendering.CrossRequestManager = function (oCrosstab, oRenderEngine) {
      ...
      this.saveTableDimensions = function () {
        if (oCrosstab.getPropertyBag().isPixelScrolling()) {
          var oDomDataArea = jQuery(document.getElementById(oCrosstab.getId() + "_dataArea"));
      ...
      this.getScrollManager = function () {
        if (!oScrollManager) {
          if (oCrosstab.getPropertyBag().isPixelScrolling()) {
            oScrollManager = new PixelScrollManager(oCrosstab, oRenderEngine);
          } else {
            oScrollManager = new ScrollManager(oCrosstab, oRenderEngine);
          }
          if (bHasSavedInfo) {
      ...
      this.getHeaderScrollManager = function() {
        if (!oHeaderScrollManager) {
          oHeaderScrollManager = new HeaderScrollManager(oCrosstab, oRenderEngine);
          if (bHasSavedInfo) {
