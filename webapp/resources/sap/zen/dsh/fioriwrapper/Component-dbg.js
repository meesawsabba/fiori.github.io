...
sap.ui.define(
  ...
  function (Log, UIComponent, NavigationHandler, Dsh) {
    "use strict";
    return UIComponent.extend(
      "sap.zen.dsh.fioriwrapper.Component",
      {
        ...
        createContent: function() {
          ...
          if (loConfig) {
            if (loConfig && loConfig.semanticObjectMappings) {
              ...
              for (var lKey in loMappings) {
                if (Object.prototype.hasOwnProperty.call(loMappings, lKey)) {
          ...
          Log.info("Unused appname: " + lAppName );
          var lQuery = "";
          ...
          loParseNavigationPromise.fail(
            function(oError){
              ...
              if (that.getComponentData().startupParameters) {
                for (var lParam in that.getComponentData().startupParameters) {
                  if (Object.prototype.hasOwnProperty.call(that.getComponentData().startupParameters, lParam) &&
                    ...
                    if (loMappings && Object.prototype.hasOwnProperty.call(loMappings, lParam)) {
        ...
        init: function() {
          ...
          UIComponent.prototype.init.apply(this, arguments); // calls createContent (among others)
        },
        getManifestEntry: function(sKey) {
          if (sKey === "/sap.app/ach" && this.sAchComponent) {
            ...
            return UIComponent.prototype.getManifestEntry.apply(this, arguments);
          }
        }
      }
    );
