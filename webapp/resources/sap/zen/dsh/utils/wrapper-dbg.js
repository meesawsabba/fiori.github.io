...
sap.ui.define(
  ...
  function(jQuery, Log ){
    "use strict";
    jQuery.sap.declare("sap.zen.dsh.utils.Wrapper");
    var Wrapper = function() {
      ...
      this.wrapper.TextPool = function(org, result) {
      ...
      this.wrap = function(wrapperName, org) {
        ...
        if (!this.wrapper[wrapperName]) {
          if (org.getMessageWriter()) {
            org.getMessageWriter().createErrorMessage("sap.zen.dsh.utils.Wrapper: " + wrapperName + "not found!");
          } else {
            Log.error("sap.zen.dsh.utils.Wrapper: " + wrapperName + "not found!");
          }
          return org;
        }
    ...
    sap.zen.dsh.utils.Wrapper = new Wrapper();
    return sap.zen.dsh.utils.Wrapper;
  }
);
