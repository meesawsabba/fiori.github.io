...
sap.ui.define(
  ...
  function(jQuery, BaseHandler, SDKUtilsHelper, ChartException){
    "use strict";
    var SDKChartDataFeedingHelper = function(){
      ...
      var getScatterFeedingColor = function (rowDimensionCounter) {
        if (rowDimensionCounter > 0)
          return [ANALYSIS_AXIS_INDEX_1];
        return [];
      };
      ...
      this.updateMultiLayout = function(newChartOptionsProperties, chartOption){
        ...
        jQuery.extend(chartOption, multiLayoutOpt);
      };
    };
