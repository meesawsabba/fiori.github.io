...
sap.ui.define(
  ...
  function(jQuery,BaseHandler){
      ...
      function init (oAbsLayout, oControlProperties) {
        ...
        if(oControlProperties.newurl){
          if(oControlProperties.newurl.length && oControlProperties.newurl.length >= 8 && oControlProperties.newurl.substring(0,7) === "mailto:"){
            ...
            if(sap.zen.dsh.sapbi_Mobile && (sap.zen.dsh.sapbi_Mobile.mobi.iPad || sap.zen.dsh.sapbi_Mobile.mobi.iPhone)){
        ...
        if(oControlProperties.loadingIndicatorDelay){
          sap.zen.dsh.getLoadingIndicator().setDelay(oControlProperties.loadingIndicatorDelay);
        }
        if (aChildren) {
        ...
        if (id === "ROOT_absolutelayout") {
          if (this.rootNeedsToBeDropEnabled(dispatcher) === true) {
            ...
            oAbsLayout.destroy = function () {
              jQuery(document.getElementById(this.getId())).droppable("destroy");
            ...
            oAbsLayout.onAfterRendering = function () {
              ...
              jQuery(document.getElementById(this.getId())).droppable({
                greedy: true,
    ...
    var instance = new AbsoluteLayoutHandler();
