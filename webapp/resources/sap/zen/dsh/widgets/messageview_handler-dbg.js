...
sap.ui.define(
  ...
  function(jQuery,BaseHandler,JSONModel){
    "use strict";
    sap.zen.MessageViewHandler = function () {
      ...
      var oDataModel = null, oJsonModel = null;
      var oRenderData = {
        hDist: 15,
        vDist1: 15,
        vDist2: 80,
      ...
      var oTexts = {}, oHeaderText = null, applicationProperties = {}, heightExpanded = "180px", heightCollapsed = "60px", position = {
        top: "auto",
        bottom: "auto",
        left: "auto",
        right: "auto"
          ...
          if (!oAbsLayout.fSaveOnAfterRendering) {
            ...
            oAbsLayout.onAfterRendering = function() {
              ...
              if (!sap.zen.MessageViewHandler.bIsVariableScreen) {
                ...
                var oJqAbsLayout = jQuery(window.document.getElementById(this.getId()));
      ...
      this.buildUI = function (id, oComponentProperties) {
          ...
          .bindAggregation(
            "rows",
            {
              ...
              factory: function (sId, oContext) {
                ...
                oRowBorderLayout.addContent(
                  sap.ui.commons.layout.BorderLayoutAreaTypes.begin,
                  oExpandImage
                );
                oRowBorderLayout.setAreaData(
                  sap.ui.commons.layout.BorderLayoutAreaTypes.begin, {
                    size: "36px",
                    visible: true
                  }
        ...
        if (sap.zen.dsh.sapbi_isMobile) {
          oMainBorderLayout.attachBrowserEvent("touchstart", function () {
            var layNullCenter = jQuery(this.$().children()[1]);
          ...
          oMainBorderLayout.attachBrowserEvent("touchmove", function (e) {
            ...
            if (maxScrollTop < 5 || !jQuery(e.target).parents("#" + layNullCenter.attr("id")).length) {
              return false;
            }
        ...
        if (applicationProperties.message_popup_position === "LEFT") {
          if (applicationProperties.message_position === "BOTTOMLEFT"
            ...
            if (sap.zen.MessageViewHandler.fCalculationCallback) {
              sap.zen.MessageViewHandler.fCalculationCallback(
                offset,
    ...
    sap.zen.MessageViewHandler.JSMessageHandler = new function () {
      ...
      this.allowDynSizeBehavior = function (bAllow) {
        ...
        function doResize (bOnAfterRendering) {
          var oDomLayout = jQuery(document.getElementById(that.oRenderData.oMainLayout.getId()));
          var iBottom = parseInt(oDomLayout.css("bottom"), 10);
          var iWindowHeight = parseInt(jQuery(window).innerHeight(), 10);
        ...
        if(bAllow){
          ...
          this.oRenderData.oMainLayout.onAfterRendering = function () {
            ...
            if (that.oRenderData.iInitialLayoutHeight === 0) {
              that.oRenderData.iInitialLayoutHeight = parseInt(
                jQuery(document.getElementById(this.getId())).css("height"), 10
              );
            }
            ...
            if (that.bAutoClose) {
              ...
              for (i = 0; i < that.aPopupAreaIds.length; i++) {
                ...
                if (id) {
                  oDomArea = jQuery(document.getElementById(id));
      ...
      this.logMessage = function (sLevel, sShortText, sLongText) {
        if (this.sLogCommand) {
          ...
          sCommand = BaseHandler.dispatcher.prepareCommand(sCommand, "__LEVEL__", sLevel);
          sCommand = BaseHandler.dispatcher.prepareCommand(sCommand, "__SHORTTEXT__", sShortText);
          sCommand = BaseHandler.dispatcher.prepareCommand(sCommand, "__LONGTEXT__", sLongText);
