...
sap.ui.define(
  ...
  function(jQuery){
    jQuery.sap.declare("sap.zen.dsh.zen_rt_components_ui5");
    sap.zen.dsh.com_sap_ip_bi_FormattedTextView = {
    ...
    sap.zen.dsh.com_sap_ip_bi_FragmentGallery = {
    ...
    sap.zen.dsh.com_sap_ip_bi_DataSourceBrowser = {
      getRootFolders: function(browseType) {
        return sap.zen.dsh.COMPONENTS[this.owner].getRootFolders(browseType);
      },
      getChildren: function(parent) {
        return sap.zen.dsh.COMPONENTS[this.owner].getChildren(parent);
      },
      searchDataSources: function(searchPattern) {
        return sap.zen.dsh.COMPONENTS[this.owner].searchDataSources(searchPattern);
      },
      close: function(arg) {
        sap.zen.dsh.COMPONENTS[this.owner].dialogClosed(arg);
      }
    };
    sap.zen.dsh.com_sap_ip_bi_SelectionTable = {
      ...
      getDataSourceNames: function() {
        var dss= sap.zen.dsh.APPLICATION.getDataSources();
        return dss.map(function(val) {
          return val.get_VariableName();
        });
      },
      getDataSourceByName: function(name) {
        var dataSource = sap.zen.dsh.COMPONENTS[name];
    ...
    sap.zen.dsh.IconBackgroundShapeEnumfield = {
    };
    sap.zen.dsh.IconBackgroundShape = {
      RECTANGLE: "RECTANGLE",
      ELLIPSIS: "ELLIPSIS",
      NONE: "NONE"
    };
    sap.zen.dsh.com_sap_ip_bi_Icon = {
    ...
    sap.zen.dsh.SwitchModeEnumfield = {
    };
    sap.zen.dsh.SwitchMode = {
      OnOff: "OnOff",
      Blank: "Blank",
      AcceptReject: "AcceptReject"
    };
    sap.zen.dsh.com_sap_ip_bi_Switch = {
      isEnabled: function() {
        return this.enabled;
      },
    ...
    sap.zen.dsh.LinkStyleEnumfield = {
    };
    sap.zen.dsh.LinkStyle = {
      Normal: "Normal",
      Subtle: "Subtle",
      Emphasized: "Emphasized"
    };
    sap.zen.dsh.com_sap_ip_bi_Link = {
    ...
    sap.zen.dsh.ProgressIndicatorStateEnumfield = {
    };
    sap.zen.dsh.ProgressIndicatorState = {
      None: "None",
      Error: "Error",
      Warning: "Warning",
      Success: "Success"
    };
    sap.zen.dsh.com_sap_ip_bi_ProgressIndicator = {
      getText: function() {
        return this.text;
      },
    ...
    sap.zen.dsh.com_sap_ip_bi_TextArea = {
    ...
    sap.zen.dsh.com_sap_ip_bi_SegmentedButton = {
