...
sap.ui.define(
  ...
  function(jQuery){
    jQuery.sap.declare("sap.zen.dsh.zen_rt_components_infochart");
    sap.zen.dsh.com_sap_ip_bi_InfoChart = {
    ...
    sap.zen.dsh.InfoChartAxisScalingEnumfield = {};
    sap.zen.dsh.InfoChartAxisScaling = {
      AXIS_1: "AXIS_1",
      AXIS_2: "AXIS_2"
    };
    sap.zen.dsh.InfoChartTypeEnumfield = {};
    sap.zen.dsh.InfoChartType = {
