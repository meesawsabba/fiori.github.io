  ...
  function(jQuery, _, BaseHandler,transitions) {
    ...
    var PopupHandler = function() {
      ...
      this.createAndAdd = function (oChainedControl, oControlProperties, oComponentProperties, fAppendToParentFunclet, iIndex) {
        var store = null, properties = {}, oAbsLayout, oText;
        ...
        if(sap.zen.designmode) {
          ...
          BaseHandler.dispatcher.updateComponentProperties(oAbsLayout, oComponentProperties);
      ...
      this.update = function(oControl, oControlProperties, oComponentProperties) {
        var oPopupProperties = oControl.oPopupProperties;
        var oAbsLayout =  oPopupProperties.isAbsLayout ? oControl : oPopupProperties.oAbsLayout;

        oControlProperties = oControlProperties || {};
        init(oAbsLayout, oControlProperties);

        if(!sap.zen.designmode && Object.prototype.hasOwnProperty.call(oControlProperties, "show")) {
          if (oControlProperties.show) {
            ...
            } else if(!Object.prototype.hasOwnProperty.call(oControl, "oPopup") && !sap.zen.designmode){     // initial hide before show
      ...
      this.remove = function(oControl) {
        ...
        if(oControl.zenPopupHackId) {
          ...
          if(oPopup) {
            BaseHandler.dispatcher.dispatchRemove(oPopup);
          }
        }
      };
      ...
      this.createPopup = function(oControl, oControlProperties, oAbsLayout) {
        ...
        oControl.oPopup = new sap.ui.core.Popup(
          oAbsLayout, // content
      ...
      this.configureTransitions = function(oControl, oControlProperties) {
        var handler = this.getTransitionHandler(oControlProperties.animation.toLowerCase(), oControl.oPopupProperties.positioner);
    ...
    var Positioning = function () {
      var defaultOffset = "13 -10", startPositionFallback = 1000;
      ...
      this.calculateRedocking = function(ref) {
        var deltaWidth = Math.round(ref.outerWidth()-ref.width());
        var deltaHeight = Math.round(ref.outerHeight()-ref.height());
        var dockingPosition = {
          top: "auto",
          bottom: "auto",
          left: "auto",
      ...
      this.calculateDimensions = function(oComponentProperties) {
        ...
        var viewportWidth = jqBody.width(), viewportHeight = jqBody.height();
      ...
      this.calculatePosition = function(oComponentProperties, nearbyControl) {
        var popupDock, viewportDock, horizontalGap, verticalGap;
