...
sap.ui.define(
  ...
  function(jQuery, Log, Carousel, BaseHandler){
    "use strict";
    Carousel.extend(
      "com.sap.ip.bi.FragmentGallery",
      {
          ...
          for(var i = 0; i < content.length; i++) {
            ...
            if(oLayout.getDomRef() != null) {
              ...
              if(oLayout.zenSelected) {
                jQuery(oLayout.getDomRef().parentElement).addClass("selectedItem");
              } else {
                jQuery(oLayout.getDomRef().parentElement).removeClass("selectedItem");
              }
            }
          }
        },
        ...
        createItemContent: function(itemArray, dragEnabled){
          ...
          for (var i = 0; i < itemArray.length; i++ ) {
            ...
            if(dragEnabled) {
              var dragArea = new BaseHandler.dispatcher.dragArea(galleryItem, "", {bmid:itemArray[i].key,title:itemArray[i].text}, null, null, null, null, null, null);
              BaseHandler.dispatcher.dragHandlerInstance.registerDragArea(dragArea);
            }
        ...
        createImageLayout: function(item){
          ...
          if (item != null) {
            var oItemLayout = new sap.zen.commons.layout.AbsoluteLayout(
              this.sId + "ly-" + item.key,
              {
                width: "45%",
              }
            ).attachBrowserEvent(
            ...
            oItemLayout.onAfterRendering = function () {
              ...
              if(oItemLayout.zenSelected){
                jQuery(oItemLayout.getDomRef().parentElement).addClass("selectedItem");
              } else {
                jQuery(oItemLayout.getDomRef().parentElement).removeClass("selectedItem");
              }
            };
        ...
        updateLastItemStyle: function() {
          ...
          var contentarea = jQuery(document.getElementById(this.sId + "-contentarea"));
          var sapCrslScl = jQuery(document.getElementById(this.sId + "-scrolllist"));
          var margins = 10;     // px
        ...
        showNext: function() {
          ...
          if ((this.getFirstVisibleIndex() + numVisibleItems) < this.getContent().length) {     // showNext
            ...
            $ScrollList.animate(
              mAnimationArguments, this.getAnimationDuration(),
              function() {
