...
sap.ui.define(
  ...
  function(
    jQuery, Log, JSONModel,ResourceModel, BaseHandler
  ){
    "use strict";
    sap.ui.controller(
      "dsb.datasourcebrowser",
      {
        ...
        onInit: function() {
          ...
          this.oResourceModel = new ResourceModel({
            bundleUrl: "sap/zen/dsh/i18n/dsb/localization.properties"
          });
          ...
          if (configJson.defaultTab) {
            ...
            if (!BaseHandler.dispatcher.isMainMode()) { //UI5 CLASSIC
