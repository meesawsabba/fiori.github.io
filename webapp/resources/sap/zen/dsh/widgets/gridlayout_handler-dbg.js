...
sap.ui.define(
  ...
  function(BaseHandler,MatrixLayout,Padding){
    "use strict";
    var dispatcher = BaseHandler.dispatcher;
    var GridLayoutCellHandler = function () {
      BaseHandler.apply(this, arguments);
      var that = this;
      this.createAndAdd = function (
        oChainedControl, oControlProperties, oComponentProperties, fAppendToParentFunclet,
        oArgForFunclet
      ) {
    ...
    var GLCHinstance = new GridLayoutCellHandler();
    BaseHandler.dispatcher.addHandlers(GLCHinstance.getType(), GLCHinstance);
    ...
    var GLCSHinstance = new GridLayoutCellSimpleHandler();
    BaseHandler.dispatcher.addHandlers(GLCSHinstance.getType(), GLCSHinstance);
    sap.zen.dsh.sapbi_registerHandlers([GLCHinstance, GLCSHinstance]);
    var GridLayoutHandler = function () {
      ...
      this.createAndAdd = function (oChainedControl, oControlProperties, oComponentProperties, fAppendToParentFunclet, iIndex) {
        ...
        BaseHandler.dispatcher.updateComponentProperties(oTable, oComponentProperties);
    ...
    var instance = new GridLayoutHandler();
