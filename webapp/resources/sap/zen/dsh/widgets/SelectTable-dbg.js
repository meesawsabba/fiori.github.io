...
sap.ui.define(
  ...
  function(jQuery, Log){
    "use strict";
    Log.info("Create com.sap.ip.bi.SelectionTable");
    sap.designstudio.sdk.Component.subclass(
      "com.sap.ip.bi.SelectionTable",
      function() {
        ...
        function onCellClick(e) {
          var dataCell=jQuery(e.target).hasClass(CSS_CLASS_TD_DEFAULT_EVEN);
        ...
        function renderVisualSelection() {
          if (that.jqTable) {
            jQuery("." + CSS_CLASS_SELECT_DATA_CELL, that.jqTable).removeClass(CSS_CLASS_SELECT_DATA_CELL);
            jQuery("." + CSS_CLASS_HOVER_ROW_HEADER_CELL, that.jqTable).removeClass(CSS_CLASS_HOVER_ROW_HEADER_CELL);
            ...
            do {
              ...
              jQuery.each(visSelection, function(iIndex, values) {
                ...
                if (value !== undefined) {
                  ...
                  jQuery("." + CSS_CLASS_HEADER_CELL_DEFAULT +line, that.jqTable).addClass(CSS_CLASS_HOVER_ROW_HEADER_CELL);
                }
              });
              var cellsToHighlight = jQuery(sjQuerySelector, that.jqTable);
          ...
          if (value === undefined) {
            ...
            jQuery.each(getVisSelection(false), function(index, value) {
              ...
              if (value.length === 1) {
                ...
                jsonResult[dimName] = value.map(
                  function(i) {
                    return stringfySinlgeMember(dim, i);
                  }
                );
              }
            });
            ...
            if (value !== "" && data) {
              ...
              try {
                ...
                for (var dimName in jsonValue) {
                  if (Object.prototype.hasOwnProperty.call(jsonValue, dimName)) {
