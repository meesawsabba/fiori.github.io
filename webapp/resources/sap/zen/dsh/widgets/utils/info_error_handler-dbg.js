...
sap.ui.define(
  ...
  function(jQuery,_, BaseHandler) {
    ...
    var     LEVELS = [INFO_LEVEL, WARN_LEVEL, ERROR_LEVEL];
    var    global = window; // FIXME
    ...
    function logError(e, errorInfo) {
      if (e.message === "control.waitForReady") { // do not log this and display in console
        return;
      }
    ...
    function displayError(control, errorInfo, isDesignTime) {
      ...
      var $controlDiv = control.getControlDiv();
      ...
      control.showLoadingState = true;
      BaseHandler.dispatcher.addMessageOverlay(
        control, control.showLoadingStateText,
