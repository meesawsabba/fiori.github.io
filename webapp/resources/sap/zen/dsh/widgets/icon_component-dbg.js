...
sap.ui.define(
  ...
  function(jQuery, Log, Icon, BaseHandler){
    "use strict";
    return Icon.extend(
      "com.sap.ip.bi.Icon",
      {
        initDesignStudio: function() {
          BaseHandler.dispatcher.registerResizeHandler(this, this);
          this.attachPress(
            function() {
        ...
        onAfterRendering : function() {
          if (Icon.prototype.onAfterRendering) {
            Icon.prototype.onAfterRendering.apply(this, arguments);
          }
          this.endResize();
        ...
        setHeight: function(value) {
          Icon.prototype.setHeight.call(this, value);
          this.onAfterRendering();
        },
        setWidth: function(value) {
          Icon.prototype.setWidth.call(this, value);
          this.onAfterRendering();
        },
        getIconUri: function() {
          return this.getSrc();
