  ...
  function( jQuery, Log, Request, _){
    ...
    VizFrame.prototype.create = function(contain, metadata, info_ctrl) {
      ...
      try {
        ...
        this._vizframe.on("contextualData", function(e) {
          ...
          var sContextMenuCommand = Request.zenSendCommandArrayWoEventWZenPVT(commandArgs);
    ...
    VizFrame.prototype.getCharacteristic = function(data, type) {
      ...
      if ((data.length !== 0) && (type === "axisLabel")) {
        var selectedDom = jQuery(".v-axis-item").find(".v-hovershadow").parent();
        ...
        var categoryAxisBinding = _.find(allBindings, {
          feed: "categoryAxis"
        });
