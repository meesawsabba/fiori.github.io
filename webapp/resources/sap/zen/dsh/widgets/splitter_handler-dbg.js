  ...
  function(BaseHandler){
    ...
    var SplitterHandler = function() {
      ...
      this.init = function(oControl, oControlProperties) {
        ...
        this.updateChildren(ltChildren, oControl, function(oContentArea) {
      ...
      this.resize = function(oControl, tNewSizes) {
        ...
        // collect new sizes
        var ltNewSizes = [];
        for ( i=0; i<tNewSizes.length; i++) {
          lNewSize = tNewSizes[i];
    ...
    var instance = new SplitterHandler();
    ...
    instance = new sap.zen.ContentAreaHandler();
    BaseHandler.dispatcher.addHandlers(
      instance.getType(),
