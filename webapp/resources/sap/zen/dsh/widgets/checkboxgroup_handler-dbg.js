...
sap.ui.define(
  ...
  function(jQuery, _, BaseHandler,CheckBoxM,CheckBoxC) {
    "use strict";
    var toInheritFrom = BaseHandler.dispatcher.isMainMode()? CheckBoxM : CheckBoxC;
    toInheritFrom.extend(
      "sap.zen.ZenCheckbox", {
        // the control API:
        metadata : {
          properties : {
    ...
    var instance = new CheckboxGroupHandler();
