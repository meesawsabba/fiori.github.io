...
sap.ui.define(
  ...
  function(Log , BackgroundDesign, Padding,Separation, HAlign, VAlign) {
    "use strict";
    /**
        ...
        for (j = 0; j < iColumns; j++) {
          ...
          if (oMatrixLayoutCell) {
            ...
            if (oMatrixLayoutCell.getColSpan() > 1) {
              rm.writeAttributeEscaped("colspan", oMatrixLayoutCell.getColSpan());
              iColSpans = iColSpans + oMatrixLayoutCell.getColSpan() - 1;
              bColspanInRow = true;
            }
            if (oMatrixLayoutCell.getRowSpan() > 1) {
              rm.writeAttributeEscaped("rowspan", oMatrixLayoutCell.getRowSpan());
     ...
     * was given.
     *
     * @param {sap.zen.commons.HAlign} oHAlign horizontal alignment of the cell
     ...
     *
     * @param {sap.zen.commons.VAlign} oVAlign vertical alignment of the cell
     ...
     * none is needed.
     *
     * @param {sap.zen.commons.Padding} oPadding padding of the cell
     * @return {string} classname
     * @protected
     */
     ...
     * none is needed.
     *
     * @param {sap.zen.commons.Separation} oSeparation separation of the cell
     * @return {string} classname
     * @protected
     */
