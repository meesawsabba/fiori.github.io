...
sap.ui.define([
    ...
    var RTAPlugin = BaseRTAPlugin.extend("sap.ushell.plugins.rta-personalize.Component", {
        ...
        _onAdapt: function (oEvent) {
            return Promise.resolve(oEvent.getSource())
                ...
                .then(function (mProperties) {
                    if (!mProperties.flexEnabled) {
                        this.oTrigger.handleFlexDisabledOnStart();
                    } else if (mProperties.source.getText() === this.mConfig.i18n.getText("PERSONALIZE_BUTTON_TEXT")) {
                        ...
                        if (!sSapUiLayer || sSapUiLayer === "USER") {
                            mProperties.source.setText(this.mConfig.i18n.getText("END_PERSONALIZE_BUTTON_TEXT"));
