...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.renderers.fiori2.allMyApps.AllMyApps", {
         ...
         */
        onInit: function () {
            sap.ushell.Container.getServiceAsync("AllMyApps"); // Make sure the service is preloaded for all synchronous calls below
        ...
        handleMasterListItemPress: function (event) {
            var sClickedDataSourcePath = this._getClickedDataSourceItemPath(event),
                oView = this.getView(),
                oAllMyAppsModel = oView.getModel("allMyAppsModel"),
                ...
                oCustomPanel = this._getCustomPanel(),
            ...
            if (bIsCatalog || (oAllMyAppsLevel === AllMyAppsState.FirstLevelSpread) || (oAllMyAppsLevel === AllMyAppsState.SecondLevel)) {
                oBindingContext = this.handleMasterListItemPressToDetails(event);
            } else {
                oBindingContext = this.handleMasterListItemPressToSecondLevel(event);
            }
         ...
         */
        handleMasterListItemPressToSecondLevel: function (obj) {
         ...
         *   -- BackButton visible
         *
         * @param {sap.ui.base.Event} event The master list item press event
         * @returns {object} The bindingContext of the clicked object
         */
        handleMasterListItemPressToDetails: function (event) {
            var sClickedDataSourcePath = this._getClickedDataSourceItemPath(event),
                oView = this.getView(),
                oAllMyAppsModel = oView.getModel("allMyAppsModel"),
        ...
        _isSingleDataSource: function () {
            ...
            return oAllMyAppsService.isExternalProviderAppsEnabled() &&
        ...
        _getClickedDataSourceItemPath: function (event) {
            var oClickedDataSourceItem = event.getParameter("listItem");

            return oClickedDataSourceItem.getBindingContext("allMyAppsModel").getPath();
        },
