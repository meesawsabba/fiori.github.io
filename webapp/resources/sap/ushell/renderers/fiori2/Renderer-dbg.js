...
sap.ui.define([
    ...
    var Renderer = UIComponent.extend("sap.ushell.renderers.fiori2.Renderer", {
        ...
        init: function () {
            ...
            var fnPrepareHomepage = function (oEvent) {
                ...
                var sRootIntent = that.getShellConfig().rootIntent;
    ...
    Renderer.prototype.createContent = function () {
        ...
        if (viewData.config && viewData.config.customViews) {
            Object.keys(viewData.config.customViews).forEach(function (sViewName) {
                var oCreatedView = viewData.config.customViews[sViewName];
                sap.ui.view(sViewName, {
                    type: oCreatedView.viewType,
                    viewName: oCreatedView.viewName,
                    viewData: oCreatedView.componentData
                });
            });
        }
     ...
     * @since 1.30
     * @deprecated since version 1.48. Use addUserAction instead.
     * @public
     */
