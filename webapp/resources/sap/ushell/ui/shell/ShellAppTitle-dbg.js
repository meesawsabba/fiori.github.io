    ...
    var ShellAppTitle = Button.extend("sap.ushell.ui.shell.ShellAppTitle", {
        ...
        renderer: {
            ...
            render: function (oRm, oControl) {
                ...
                var bVisible = oControl._getControlVisibilityAndState(),
                ...
                oRm.openStart("span", oControl.getId() + "-button");
                ...
                if (bVisible && sText) { // Chevron Icon
                    oRm.openStart("span");
                    oRm.class("sapUshellShellHeadAction");
                    oRm.openEnd(); // span - tag
                    oRm.openStart("span");
                    oRm.class("sapUshellShellHeadActionImg");
                    oRm.openEnd(); // span - tag;
