...
sap.ui.define([
    ...
    DynamicTileRenderer.renderPart = function (oRm, oControl) {
        ...
        oRm.addClass(State[oControl.getNumberState()] ? "sapUshellDynamicTileData" + oControl.getNumberState() :
        ...
        if (StateArrow[oControl.getStateArrow()]) {
            ...
            oRm.addClass("sapUshellDynamicTileData" + StateArrow[oControl.getStateArrow()]);
            oRm.writeClasses();
            oRm.write(">");
            oRm.write("</div>");
        }
