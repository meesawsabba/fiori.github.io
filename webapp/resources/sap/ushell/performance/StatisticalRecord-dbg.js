...
sap.ui.define([], function () {
    ...
    StatisticalRecord.prototype._calculateStep = function () {
        ...
        //load home page
        if (this.sourceApplication === undefined && _isHomePage(this.targetApplication)) {
        ...
        if (this.sourceApplication && !_isHomePage(this.targetApplication) && !_isHomePage(this.sourceApplication)) {
        ...
        if (_isHomePage(this.sourceApplication)) {
