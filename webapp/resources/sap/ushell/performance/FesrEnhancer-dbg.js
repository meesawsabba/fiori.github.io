...
sap.ui.define([
    ...
    var oFesrEnhancer = {
        ...
        _onBeforeCreatedHandler: function (oUi5FesrHandle, oUi5Interaction) {
            ...
            return this._enhanceRecord(oDetectedScenario.scenario, oUi5FesrHandle, oDetectedScenario.relatedEvent);
        },
        ...
        _enhanceRecord: function (sDetectedScenario, oIntermediateResult, oRelatedEvent) {
            ...
            // unknown scenario
            Log.warning("Unknown scenario at the end of execution, unnecessary code executed",
        ...
        _enhanceInitialStart: function (oIntermediateResult, sStepName, sPerformanceMarkName) {
            ...
            if (sPerformanceMarkName) {
                ...
                Log.warning("Scenario '" + sStepName + "' detected but expected performance mark '" +
