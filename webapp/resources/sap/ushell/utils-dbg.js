...
sap.ui.define([
     ...
     *
     * This method is currently used upon navigation (i.e. Shell.controlelr - openApp) as there is logic running in the background
    ...
    utils.urlParametersToString = function (parameters, delimiter, assign) {
        // Impementation was moved to UrlParsing to resolve circular dependency of modules
    ...
    utils.isFlpHomeIntent = function (sIntent) {
        ...
        // validate configured intent
        var sIntentNoHash = sIntent.replace("#", "");
        return sIntentNoHash.indexOf("Shell-home") === 0 || sIntentNoHash.indexOf("Launchpad-openFLPPage") === 0;
    };
