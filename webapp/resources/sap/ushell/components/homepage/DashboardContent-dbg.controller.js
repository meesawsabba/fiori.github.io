            ...
            if (Device.system.desktop) {
                ...
                if (document.activeElement.tagName !== "INPUT" && bSlideTile !== true) {
                    if (sap.ui.getCore().byId(oTileControl.getId())) {
                        pPro = ComponentKeysHandler.getInstance().then(function (ComponentKeysHandlerInstance) {
                            ComponentKeysHandlerInstance.setTileFocus(oTileControl.$());
                        });
                    }
                }
            } else {
                pPro = Promise.resolve();
            }
            pPro.then(function () {
