...
sap.ui.define([
    ...
    "sap/m/IconTabFilter",
    "sap/ushell/utils"
], function (CustomData, Controller, JSONModel, ObjectPath, EventHub, resources, WindowUtils, IconTabFilter, ShellUtils) {
    "use strict";
    ...
    return Controller.extend("sap.ushell.components.shell.MenuBar.controller.MenuBar" /** @lends sap.ushell.components.shell.MenuBar.controller.MenuBar.prototype */, {
        ...
        onInit: function () {
            ...
            this.oSpacesPagesHierarchy = sap.ushell.Container.getServiceAsync("Menu")
        ...
        _selectIndexAfterRouteChange: function () {
            ...
            return Promise.all([
                ...
                if (oHashParts.semanticObject === "Shell" && oHashParts.action === "home") {
                    ...
                    sSelectedMenuKey = (oSpaceWithPage) ?
                        this._getMenuUID(aMenuEntries, oSpaceWithPage.id, oSpaceWithPage.pages[0].id) || "" : "";
