...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.Settings.userLanguageRegion.LanguageRegionSelector", {
        onInit: function () {
            ...
            // UserInfo service is always present. getService is allowed here.
            ...
            var bIsEnableSetUserPreference = this.userInfoService.getUserSettingListEditSupported();//Check if adapter supports user setting editing
            ...
            if (aUserPreferenceAndLanguageSettingPromises.length > 0) {
                ...
                Promise.all(aUserPreferenceAndLanguageSettingPromises).then(function (aResults) {
        ...
        _loadUserSettingList: function () {
            ...
            return new Promise(function (resolve) {
                Measurement.start("FLP:LanguageRegionSelector._loadUserSettingList", "_loadUserSettingList", "FLP");
                this.userInfoService.getUserSettingList()
                    .then(function (oData) {
