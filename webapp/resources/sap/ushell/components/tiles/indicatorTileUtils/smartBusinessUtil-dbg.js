        ...
        return {
            ...
            addSystemToServiceUrl: function (url, system) {
                ...
                if (sap.ushell && sap.ushell.Container) {
                    if (system) {
                        url = new UrlParsing("URLParsing").addSystemToServiceUrl(url, system);
                    } else {
                        url = new UrlParsing("URLParsing").addSystemToServiceUrl(url);
                    }
                } return url;
            },
            ...
            getNavigationTarget: function (jConfig, system) {
               ...
               var oCrossAppNavigator = fgetService && fgetService("CrossApplicationNavigation").then(function () {
                var each;
                var param = {};
