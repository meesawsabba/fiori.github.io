...
sap.ui.define([
    ...
    return Controller.extend(COMPONENT_NAME, {
        ...
        onInit: function () {
            ...
            var oConfig = utilsRT.getConfiguration(oTileApi, oTileApi.configurationUi.isEnabled(), false);
        ...
        successHandlerFn: function (oResult) {
            ...
            var oDataToDisplay = utilsRT.getDataToDisplay(oConfig, oResult);
            ...
            // rewrite target URL
            oModel.setProperty("/nav/navigation_target_url", utilsRT.addParamsToUrl(
        ...
        refeshAfterInterval: function (iRefreshInterval) {
            ...
            }.bind(this), iRefreshInterval * 1000);
        },
