...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.pages.controller.ImportDialog", {
        ...
        open: function () {
            if (!this._pFragmentLoad) {
                this._pFragmentLoad = Fragment.load({
                    ...
                    MyHomeImport.getData().then(function (groups) {
            ...
            return this._pFragmentLoad.then(function () {
                this._oDialog.open();
                return this._oDialog;
            }.bind(this));
        },
        ...
        _saveImport: function (groups) {
            ...
            // Initialize storage for required operations
            this.aTilesUpdateNeeded = [];
            this.aTilesMoveNeeded = [];
            ...
            }.bind(this)).then(function (oMyHomeContentNode) {
