                ...
                if (isSpacesEnabled() && (sHash === "Shell-appFinder")) {
                    ...
                    loadVisualizationOrganizer()
                        ...
                        .then(function () {
                            ...
                            if (oVisualizationOrganizer.getPersonalizablePages().length === 1 && oAppFinderView) {
            ...
            return loadVisualizationOrganizer().then(function () {
                ...
                if (oSectionContext) {
                    var sTitle = oSectionContext.sectionTitle
                        ...
                        : resources.i18n.getText("VisualizationOrganizer.AppFinderSectionContextTitleUnnamed");
