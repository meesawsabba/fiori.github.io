    ...
    var SessionHandler = function (AppLifeCycle) {
        ...
        this.notifyServer = function () {
            var timeSinceLastActionInMilliseconds = this._getCurrentDate() - new Date(this.getTimestampFromStorage()),
                timeSinceLastActionInMinutes = timeSinceLastActionInMilliseconds / (1000 * 60);
            ...
            this.notifyServerTimer = setTimeout(this.notifyServer.bind(this), this.oConfig.sessionTimeoutIntervalInMinutes * 60 * 1000);
        };
        ...
        this.checkStopBackendRequestRemainingTime = function () {
            var sTimeSinceLastActionInMilliseconds = this._getCurrentDate() - new Date(this.getTimestampFromStorage()),
                sTimeSinceLastActionInMinutes = sTimeSinceLastActionInMilliseconds / (1000 * 60),
                sReminderIntervalInMinutes = this.oConfig.sessionTimeoutTileStopRefreshIntervalInMinutes,
