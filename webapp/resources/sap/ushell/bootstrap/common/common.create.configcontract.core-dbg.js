    ...
    function createConfigContract (oMergedSapUshellConfig) {
        ...
        var oConfigDefinition = {
            core: { // the unified shell core
                ...
                menu: { // Menu Bar
                    enabled: getConfigValue("ushell/menu/enabled", false) || getConfigValue("ushell/spaces/enabled", false),
                ...
                shellHeader: {
                    ...
                    headerVisible: true,
                    showLogo: false,
                    newDesignSwitchVisible: getConfigValue("renderers/fiori2/componentData/config/sapHorizonEnabled", false) && getEnablePersonalization(),
                    newDesignSwitchActive: false,
