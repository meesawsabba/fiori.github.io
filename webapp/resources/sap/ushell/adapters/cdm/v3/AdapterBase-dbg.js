...
sap.ui.define([
    ...
    AdapterBase.prototype._getTileUiComponentContainerSync = function (oTile, oResolvedTile, bIsCatalogTile) {
        ...
        oTileComponentData = that._createTileComponentData(oTile, bIsCatalogTile, oResolvedTile);
    ...
    AdapterBase.prototype._createTileComponentData = function (oTile, bIsCatalogTile, oResolutionResult) {
        var sTitle = bIsCatalogTile ? this.getCatalogTileTitle(oTile) : this.getTileTitle(oTile),
            ...
            sNumberUnit = oTile.numberUnit || oResolutionResult.tileResolutionResult.numberUnit,
            oComponentData = {
                properties: {},
                startupParameters: {}
            };
