...
sap.ui.define([
     ...
     * CDM visualiation component using Component.create
     *
     * @returns {Promise<void>} Resolves when the component is loaded
     * @since 1.92
     * @private
    ...
    /**
     * Helper function that instantiates a custom CDM visualiation
        ...
        return sap.ushell.Container.getServiceAsync("Ui5ComponentLoader")
            .then(function (oComponentLoader) {
                var oUI5ComponentDeferred = oComponentLoader.createComponent(
                    ...
                    ushellLibrary.UI5ComponentType.Visualization
                );
