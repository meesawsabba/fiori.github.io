...
sap.ui.define([
    ...
    function Notifications (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this._activatePollingAfterInterval = function () {
            ...
            clearTimeout(pollingTimer);
            pollingTimer = setTimeout(this._activatePolling.bind(this), iPollingInterval * 1000);
        };
        ...
        this._activatePolling = function () {
            ...
            clearTimeout(pollingTimer);
            pollingTimer = setTimeout(this._activatePolling.bind(this, iPollingInterval, false), (iPollingInterval * 1000));
        };
