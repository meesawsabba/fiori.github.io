...
sap.ui.define([
     ...
     * @param {boolean} bTransient A transient appstate is not persisted on the backend,
    ...
    AppState.prototype.createEmptyAppState = function (oComponent, bTransient, sPersistencyMethod, oPersistencySettings) {
        var oAppState,
            sAppName = "",
            sACHComponent = "",
            ...
            sKey = this._getGeneratedKey(bUseTransientAppState);
    ...
    AppState.prototype.setAppStateToPublic = function (url) {
        var sXStateKey = getURLParamValue(url, "sap-xapp-state"),
            ...
            sXStateKeyNew = undefined,
            sIStateKeyNew = undefined;
