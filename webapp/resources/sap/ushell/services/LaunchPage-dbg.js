...
sap.ui.define([
    ...
    "sap/ushell/Config"
], function (Log, ContentExtensionAdapterFactory, jQuery, resources, AppStatePersistencyMethod, Config) {
    "use strict";
    ...
    function LaunchPage (oAdapter/*, oContainerInterface*/) {
         ...
         * @param {object} [oGroup]
         * @param {string} [sContentProviderId] the content provider identification in cFLP scenario
         * Optional reference to the group the bookmark tile should be added to. If not given, the default group is used.
         ...
         * @param {string} [sContentProviderId] the contentProviderId or undefined
         *
