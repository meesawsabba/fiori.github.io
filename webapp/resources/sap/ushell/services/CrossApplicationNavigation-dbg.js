...
sap.ui.define([
    ...
    var UI5ComponentType = ushellLibrary.UI5ComponentType;
    ...
    function CrossApplicationNavigation (oContainerInterface, sParameters, oServiceConf) {
        ...
        this.hrefForExternal = function (oArgs, oComponent, bAsync) {
            ...
            Log.warning("Deprecated option 'bAsync=false'. Please use 'bAsync=true' instead",
                null,
                "sap.ushell.services.CrossApplicationNavigation"
            );
         ...
         * @public
         * @deprecated since version 1.94. Use <code>isInitialNavigationAsync</code> instead
         * @alias sap.ushell.services.CrossApplicationNavigation#isInitialNavigation
         * @since 1.36.0
         */
        this.isInitialNavigation = function () {
            Log.warning("Deprecated API call of 'sap.ushell.CrossApplicationNavigation.isInitialNavigation'. Please use 'isInitialNavigationAsync' instead",
                null,
                "sap.ushell.services.CrossApplicationNavigation"
            );
        ...
        this.toExternal = function (oArgs, oComponent) {
            ...
            return Promise.resolve()
                ...
                .then(function (ShellNavigation) {
                    return ShellNavigation.toExternal(oArgsClone, oComponent, bWriteHistory);
                })
         ...
         * @since 1.15.0
         * @public
         * @deprecated since version 1.94. Use <code>hrefForAppSpecificHashAsync</code> instead
         * @alias sap.ushell.services.CrossApplicationNavigation#hrefForAppSpecificHash
         */
        this.hrefForAppSpecificHash = function (sAppHash) {
            Log.warning("Deprecated API call of 'sap.ushell.CrossApplicationNavigation.hrefForAppSpecificHash'. Please use 'hrefForAppSpecificHashAsync' instead",
                null,
                "sap.ushell.services.CrossApplicationNavigation"
            );
         ...
         * @since 1.28
         * @deprecated since version 1.95. Use <code>createEmptyAppStateAsync</code> instead
         *
         * @ignore  SAP Internal usage only, beware! internally public, cannot be changed, but not part of the public documentation
         */
        this.createEmptyAppState = function (oAppComponent, bTransient, sPersistencyMethod, oPersistencySettings) {
            Log.warning("Deprecated API call of 'sap.ushell.CrossApplicationNavigation.createEmptyAppState'. Please use 'createEmptyAppStateAsync' instead",
                null,
                "sap.ushell.services.CrossApplicationNavigation"
            );
            ...
            return AppStateService.createEmptyAppState(oAppComponent, bTransient, sPersistencyMethod, oPersistencySettings);
        };
         ...
         * @ignore  SAP Internal usage only, beware! internally public, cannot be changed, but not part of the public documentation
         */
        this.createEmptyAppStateAsync = function (oAppComponent, bTransient, sPersistencyMethod, oPersistencySettings) {
            if (!(oAppComponent instanceof sap.ui.core.UIComponent)) {
         ...
         * @deprecated since version 1.95. Use <code>getSupportedAppStatePersistencyMethodsAsync</code> instead
         */
        this.getSupportedAppStatePersistencyMethods = function () {
            Log.warning("Deprecated API call of 'sap.ushell.CrossApplicationNavigation.getSupportedAppStatePersistencyMethods'. Please use 'getSupportedAppStatePersistencyMethodsAsync' instead",
                null,
                "sap.ushell.services.CrossApplicationNavigation"
            );
            var AppStateService = sap.ushell.Cntainer.getService("AppState");
