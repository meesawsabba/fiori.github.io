...
sap.ui.define([
     ...
     *
     * @returns {Promise<object>} Resolves MyHome space. If MyHome feature is desabled, return null
     *
     * @since 1.90.0
     * @private
     */
    Menu.prototype.getMyHomeSpace = function () {
        ...
        return this.getSpacesPagesHierarchy().then(function (oSpacesPagesHierarchy) {
            return oSpacesPagesHierarchy.spaces.find(function (oSpace) {
                return oSpace.id === sMySpaceId;
            }) || null;
        });
    };
    ...
    Menu.prototype.isSpacePageAssigned = function (spaceId, pageId) {
        return this.getSpacesPagesHierarchy()
            .then(function (oHierarchy) {
                ...
                var oPage = oSpace.pages.find(function (page) {
     ...
     *  A promise resolving with a data object that contains the names
     *
     * @since 1.92.0
     * @private
     */
    Menu.prototype.getSpaceAndPageTitles = function (spaceId, pageId) {
        return this.getSpacesPagesHierarchy()
            .then(function (oHierarchy) {
                var oSpace, oPage;
                oSpace = oHierarchy.spaces.find(function (space) {
                    return space.id === spaceId;
                });
                if (oSpace) {
                    oPage = oSpace.pages.find(function (page) {
                        return page.id === pageId;
                    });
                }
                if (oPage) {
                    return {spaceTitle: oSpace.title, pageTitle: oPage.title};
                }
                return null;
            }
        );
