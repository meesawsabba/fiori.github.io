...
sap.ui.define([
    ...
    function URLParsing () {
         ...
         * @deprecated since version 1.96.0, use isIntentUrlAsync instead
         */
        this.isIntentUrl = function (sUrl) {
            Log.warning("Deprecated API call of 'sap.ushell.URLParsing.isIntentUrl'. Please use 'isIntentUrlAsync' instead",
            null,
