...
sap.ui.define([
     ...
     *
     * @private
     * @deprecated since version 1.94.
     */
     Utils.createAppStateFromData = function (oData) {
        Log.warning("Deprecated API call of '_CrossApplicationNavigation.utils.createAppStateFromData'. Please use 'createAppStateFromDataAsync' instead",
            null,
    ...
    Utils._injectParameters = function (oParams) {
        var oParametersToInject = oParams.inject,
            oInjectEmptyStringNames = (oParams.injectEmptyString || {}),
            oType = oParams.type,
            vArgs = oParams.args;
        ...
        if (oType.isPlainObject(vArgs)) {
            ...
            var oNewParameterObject = Object.keys(oParametersToInject).reduce(function (oInjectedParameters, sParameterToInject) {
                var sValueToInject = oParametersToInject[sParameterToInject],
                    bInjectWhenEmptyString = (oInjectEmptyStringNames[sParameterToInject] === true);
    ...
    Utils.injectStickyParameters = function (oParams) {
        Log.warning("Deprecated API call of '_CrossApplicationNavigation.utils.injectStickyParameters'. Please use 'injectStickyParametersAsync' instead",
            null,
            "sap.ushell.services._CrossApplicationNavigation.utils"
        );
