...
sap.ui.define([
    ...
    ShellNavigationHashChanger.prototype.hrefForExternalNoEnc = function (oArgs, bVerbose, oComponent, bAsync) {
        ...
        Log.warning("Deprecated option 'bAsync=false'. Please use 'bAsync=true' instead", null, "sap.ushell.services.ShellNavigationHashChanger");
     ...
     * @private
     */
    ShellNavigationHashChanger.prototype._trackNavigation = function (oldHash, newHash) {
    ...
    ShellNavigationHashChanger.prototype.treatHashChanged = function (newHash, oldHash) {
        this._trackNavigation(oldHash, newHash);
        ...
        if (bHaveSameIntent && this.hasListeners(O_EVENT.SHELL_HASH_PARAMETER_CHANGED.name)) {
             ...
             */
            sNewParameters = UrlParsing.paramsToString(oNewHash.params);
            sOldParameters = UrlParsing.paramsToString(oOldHash.params);
    ...
    ShellNavigationHashChanger.prototype.isInnerAppNavigation = function (sNewHash, sOldHash) {
        ...
        var bHaveSameIntentParameters = !this._parametersChanged(oNewHash.params, oOldHash.params);
