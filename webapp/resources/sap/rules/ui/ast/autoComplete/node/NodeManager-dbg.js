            ...
            switch (token.getTokenType()) {
                case Constants.TERM:
					...
					if(sText){
                        ...
                        if(!TermsProvider.getInstance().isTermParentEntity(aIds[0]) && prefixId){
                    ...
                    if (oTerm) {
                        ...
                        if (oTerm._isDataObjectElement || oTerm.isResultDataObjectElement) {
                            var attribute = TermsProvider.getInstance()._getAllAttrsRefsAssocsForDataObject(oTerm._termId)[0];
                ...
                case Constants.AMOUNTBUSINESSDATATYPE:
