...
sap.ui.define([
    ...
    function (jQuery, library, Control, SimpleForm, Label, Switch, Select, MessageBox, Table, Text, CheckBox, Input, Button,
        ...
        sap.rules.ui.DecisionTableSettings.prototype._tableColumnsFactory = function (sId, oContext) {
            ...
            var styleClass ="";
            if (this.getAstExpressionLanguage()) {
                styleClass = "sapRULDecisionTableSettingsTableContent";
            }
				...
				cells: [
                    ...
                    new sap.ui.layout.HorizontalLayout({
                        content: [
                            ...
                            }).setTooltip(this.oBundle.getText("removeColumn")).addStyleClass(styleClass),
                            new sap.m.Button({
                                type: sap.m.ButtonType.Transparent,
                            ...
                            }).setTooltip(this.oBundle.getText("addColumn")).addStyleClass(styleClass)
                        ]
                    })
                ]
            });
