...
sap.ui.define([], function() {
	 ...
	 * @returns {object} A map to the custom aggregates keyed by their qualifiers
	 */
	 ...
	 *
	 * @param {Array} mAnnos A named map of annotations from a given entity set
	 * @returns {object} A keyed mapped ordered by
	 * <ul>
	 ...
	 * @returns {boolean} `true` if the threshold should be supplied as ConstantThresholds, <code>false</code> if the threshold should
	 ...
	 *
	 * @param {object} oSortRestrictions The sort restrictions annotation
	...
	/**
	 *
	 * @param {object} oProperty The Entity Property
	 * @param {object} oSortRestrictionInfo The SortInformation restrictions
	 */
	 ...
	 *
	 * @param {object} oFilterRestrictions The filter restrictions annotation
	 * @returns {{filterable: boolean, propertyInfo: {}}} An object containing the filter restriction information
	 */
	 ...
	 *
	 * @param {object} oProperty The entity property
	 * @param {object} oFilterRestrictionInfo The filter restrictions
	 */
	 ...
	 *
	 * @param {string} sEdmType The Edm type, like Edm.String, Edm.Int16...
