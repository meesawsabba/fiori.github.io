...
sap.ui.define(
	...
	function(JSONModel, util, CommonHelper, ODataModelAnnotationHelper, Log) {
		 ...
		 * @param {string} sOperationAvailableMap The string representation of the operation availaible map
		 * @param {string} sEnableSelectOn The select Config of the action for chart
		 * @returns {*} A binding expression for enabled property of DataFieldForAction
		 */
		 ...
		 * @returns {string} A binding expression for press property of DataFieldForActionButton
		 */
		 ...
		 * @name getActionType
		 * @param {object} oAction Action model
		 * @returns {boolean} A Boolean value depending on the action type
		 */
		...
		ChartHelper.getCollectionName = function(sCollection) {
