...
sap.ui.define(
	...
	function(XMLTemplateProcessor, XMLPreprocessor, Fragment, ResourceModel, Log, JSONModel, library) {
		...
		var DraftIndicatorHelper = {
			 ...
			 * @function
			 * @name getVisible
			 * @param {boolean} bIsActiveEntity A boolean to check if the entry is active or not
			 * @param {object} oLastChangedDateTime The last change time stamp info
			 * @param {string} sIndicatorType The type of draft indicator to be rendered
			 * @returns {boolean} Whether a text or vbox to be rendered
			 */
