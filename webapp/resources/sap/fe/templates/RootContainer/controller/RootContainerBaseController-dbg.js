...
sap.ui.define(
	...
	function(
		 ...
		 *
		 * If you want to extend a base controller for your application, please use for sap.fe.templates.RootContainer.controller.Fcl or sap.fe.templates.RootContainer.controller.NavContainer
		 *
		 * @hideconstructor
		 * @public
		 * @name sap.fe.templates.RootContainer.controller.RootContainerBaseController
		 */
