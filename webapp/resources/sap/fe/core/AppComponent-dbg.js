...
sap.ui.define(
	...
	function(
		...
		var AppComponent = UIComponent.extend("sap.fe.core.AppComponent", {
			 ...
			 * @returns {oObject} A Reference to the RouterProxy
			 *
			 * @ui5-restricted
			 * @final
			 */
			 ...
			 * @memberof sap.fe.core.AppComponent
			 * @returns {oObject} A reference to the AppStateHandler
			 *
			 * @ui5-restricted
			 * @final
			 */
			 ...
			 * @memberof sap.fe.core.AppComponent
			 * @returns {oObject} A reference to the FCL Controller
			 *
			 * @ui5-restricted
			 * @final
			 */
			 ...
			 * @memberof sap.fe.core.AppComponent
			 * @returns {oObject} A reference to NavContainer control or the FCL control
			 *
			 * @ui5-restricted
			 * @final
			 */
