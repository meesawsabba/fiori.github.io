...
import { SelectionVariant, SelectionRangeType } from "@sap-ux/vocabularies-types/dist/generated/UI";
 ...
 */
export function getFilterDefinitionsFromSelectionVariant(selectionVariant: AnnotationTerm<SelectionVariant>): FilterDefinition[] {
