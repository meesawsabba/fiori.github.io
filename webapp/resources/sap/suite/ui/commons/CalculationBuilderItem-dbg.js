sap.ui.define([
	...
	CalculationBuilderItem.prototype._innerRender = function () {
		...
		sHtml += "<div id=\"" + this.getId() + "-content\" class=\"sapCalculationBuilderItemContent\"" + sAriaAttr + "\" aria-haspopup=\"dialog\">";
	...
	CalculationBuilderItem.prototype._render = function () {
		...
		var bIsItemInBuilder = this._hasCorrectParent(),
			...
			sRoleAttr = this._bIsNew ? "role=\"button\"" : "",
			sHtml = "";

		sHtml += "<div class=\"" + this._getClass(!!oError) + "\" id=\"" + this.getId() + "\" tabindex=\"" + (bIsItemInBuilder ? "-1" : "0") + "\"" + sTooltipAttr + sRoleAttr + ">";
