...
sap.ui.define([
	...
	"sap/m/Dialog"
			 ...
			 Parameters, Log, Measurement, uid, encodeXML, GraphRenderer, ToggleButton, HashChanger, MobileLibrary, Dialog) {
	"use strict";
	...
	Graph.prototype._toggleFullScreen = function () {
		...
		if (!this._oFullScreenUtil) {
			this._oFullScreenUtil = sap.ui.requireSync("sap/suite/ui/commons/util/FullScreenUtil");
		}
