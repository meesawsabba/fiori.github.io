		...
		function getControllerBase(oViewProxy, oTemplateUtils, oController){
			...
			function fnAdaptLinksToUpperLevels(){
				...
				for (var i = 0; i < iLength; i++){
					...
					oLinkInfoObject.navigate = oLinkInfo.navigate.bind(null, iDisplayMode, true);
				}
			}
			...
			oControllerBase = {
				onInit: function(oRequiredControls, fnPrepareAllMessagesForNavigation, messageSorter, getGroupTitle, fnPrepareForMessageNavigation){
