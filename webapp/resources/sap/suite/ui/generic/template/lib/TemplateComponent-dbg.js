sap.ui.define(["sap/ui/core/CustomizingConfiguration",
	...
	"sap/ui/core/mvc/View"
			...
			reuseComponentHelper, CustomData, StableIdDefinition, StableIdHelper, FeLogger, AnnotationHelper, extend, deepExtend, CacheHelper, FeError) {
		"use strict";
		...
		function createParameterModel(sEntityType, oComponentRegistryEntry, oMetaModel, fnTemplateSpecificParameters) {
			...
			return new JSONModel({
				...
				templateSpecific: fnTemplateSpecificParameters && fnTemplateSpecificParameters(oMetaModel, oSettings, Device, sEntitySet, oDraftContext, oModel),
