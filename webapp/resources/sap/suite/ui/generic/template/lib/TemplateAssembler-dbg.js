...
sap.ui.define(["sap/ui/core/mvc/ControllerExtension",
		...
		"sap/suite/ui/generic/template/lib/presentationControl/PresentationControlHandlerFactory"
			...
			ComponentUtils, CommonEventHandlers, testableHelper, CommonMethods, FeLogger, deepExtend, PresentationControlHandlerFactory) {
			"use strict";
			...
			return {
				...
				getTemplateComponent: function(getMethods, sComponentName, oComponentDefinition) {
					...
					oComponentDefinition.init = function() {
						...
						oTreeNode.componentId = this.getId();
						oTemplateContract.componentRegistry[oTreeNode.componentId] = oComponentRegistryEntry;
