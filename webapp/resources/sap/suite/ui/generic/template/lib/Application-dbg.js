sap.ui.define(["sap/ui/base/Object",
	...
	function(BaseObject, Device, JSONModel, MessageToast, ActionSheet, Dialog, Popover, deletionHelper,
		routingHelper, ContextBookkeeping, CRUDHelper, testableHelper, FeLogger, oDataModelHelper,
		syncStyleClass, extend, Fragment, NavigationHandler, KeepAliveHelper) {
		"use strict";
		...
		function getMethods(oTemplateContract) {
			...
			*/
			...
			function getStatePreservationMode() {
				...
				var bIsFCLMode = oTemplateContract.oAppComponent.getFlexibleColumnLayout() ? true : false;

				if (sStatePreservationMode === "auto") {
					return bIsFCLMode ? "persistence" : "discovery";
				} 
