sap.ui.define([
	...
	"sap/base/util/deepExtend"
		...
		CustomData, Text, OverflowToolbarLayoutData, FilterOperator, Device, SimpleType, SapCoreLibrary, SapMLibrary, DatePicker, FeLogger, InvisibleText, StableIdHelper, deepExtend) {
	"use strict";
	...
	*/
	...
	SmartVisualFilterBar.prototype._createTitleToolbar = function(props, filterItem) {
		...
		if (oInput) {
			...
			sIcon = bIsValuehelp ? "sap-icon://value-help" : sShowDatePicker || sShowDropdown, count, sParentProperty, sId;
