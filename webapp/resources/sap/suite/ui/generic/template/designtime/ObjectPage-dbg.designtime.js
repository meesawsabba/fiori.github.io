...
sap.ui.define([
	...
	function(SmartForm, Group, ObjectPageLayout, ObjectPageSection, GroupElement, ObjectPageHeader, ObjectPageHeaderActionButton,
		...
		var getSmartTableProperties = function(oSmartTable) {
			var oPropertiesDenyList = DesigntimeUtils.ignoreAllProperties(oSmartTable);
			var oPropertiesAllowList = {
				//Control Properties:
				editable: { ignore: false }
			};

			return deepExtend({}, oPropertiesDenyList, oPropertiesAllowList);
		};
		...
		var getGridProperties = function(oGridData) {
			var oPropertiesDenyList = DesigntimeUtils.ignoreAllProperties(oGridData);
			var oPropertiesAllowList = {
				//Control Properties:
				span: { ignore: false },
				spanS: { ignore: false },
		...
		var getAvatarProperties = function(oAvatar) {
			var oPropertiesDenyList = DesigntimeUtils.ignoreAllProperties(oAvatar);
			var oPropertiesAllowList = {
				//Control Properties:
		...
		var getDeterminingActionProperties = function (oButton) {
			var oPropertiesDenyList = DesigntimeUtils.ignoreAllProperties(oButton);
			var oPropertiesAllowList = {
				//Control Properties:
