...
sap.ui.define([
	...
	JSONModel, Filter, RowSettings, FilterOperator, SapTableLibrary, listUtils, FeLogger, isEmptyObject) {
		"use strict";
		...
		var tController = Controller.extend("sap.suite.ui.generic.template.listTemplates.controller.DetailController", {
			...
			_onBeforeRebindTable: function(oEvent) {
				...
				this.oState.oMultipleViewsHandler.onRebindContentControl(oBindingParams, aFiltersFromSmartTable);
