...
/* global window */
sap.ui.define(
    ["sap/apf/ui/utils/formatter", "sap/viz/ui5/types/legend/Common"],
	function(formatter, Common) {
	    "use strict";
	...
	otherwise get formatted filter values for application specific filters from APF****/
		...
		sap.apf.ui.utils.PrintModel.prototype.getHeaderForFirstPage = function() {
			return this.oUiApi.getLayoutView().getController().oSavedPathName.getText();
		};
