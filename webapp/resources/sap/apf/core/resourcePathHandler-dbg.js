...
sap.ui.define([
	...
	sap.apf.core.ResourcePathHandler = function(oInject) {
		...
		function loadAnalyticalConfigurationAndRessources() {
			...
			if (typeof apfUiTextBundle === "string") {
				apfUiTextBundle = uriGenerator.addRelativeToAbsoluteURL(baseComponentUri, apfUiTextBundle);
			} else if (typeof apfUiTextBundle === "object") {
				apfUiTextBundle = uriGenerator.addRelativeToAbsoluteURL(baseComponentUri, apfUiTextBundle.bundleUrl);
			}
			var applicationUiTextBundle = manifest["sap.app"].i18n;
			if (typeof applicationUiTextBundle === "string") {
				applicationUiTextBundle = uriGenerator.addRelativeToAbsoluteURL(componentUri, applicationUiTextBundle);
			} else if (typeof applicationUiTextBundle === "object") {
				applicationUiTextBundle = uriGenerator.addRelativeToAbsoluteURL(componentUri, applicationUiTextBundle.bundleUrl);
			}
