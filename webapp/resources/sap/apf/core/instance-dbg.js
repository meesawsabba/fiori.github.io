...
sap.ui.define(['sap/apf/utils/utils', //injects on sap.apf.utils
'sap/apf/utils/filter', 'sap/apf/utils/hashtable', 'sap/apf/core/utils/checkForTimeout', 'sap/apf/core/utils/uriGenerator', 'sap/apf/core/utils/fileExists', 'sap/apf/core/utils/annotationHandler', 'sap/apf/core/utils/filter', 'sap/apf/core/messageHandler', 'sap/apf/core/path', 'sap/apf/core/persistence', 'sap/apf/core/metadataFactory', 'sap/apf/core/textResourceHandler', 'sap/apf/core/configurationFactory', 'sap/apf/core/sessionHandler', 'sap/apf/core/resourcePathHandler', 'sap/apf/core/constants', 'sap/apf/cloudFoundry/analysisPathProxy', 'sap/apf/cloudFoundry/ajaxHandler', 'sap/ui/comp/smartfilterbar/ControlConfiguration', 'sap/apf/core/metadataProperty', 'sap/apf/core/metadataFacade', 'sap/apf/core/metadata', 'sap/apf/core/readRequestByRequiredFilter', "sap/apf/core/ajax", "sap/apf/core/odataRequest", "sap/apf/core/entityTypeMetadata", "sap/apf/core/readRequest", "sap/ui/thirdparty/jquery"], function(
    utilsUtils,
	utilsFilter,
	Hashtable,
	fCheckForTimeout,
