...
sap.ui.define([
...
], function(configurationEditor, hashtable, utils, configurationObjects) {
    "use strict";
	/**
	 * @private
	...
	sap.apf.modeler.core.ConfigurationHandler = function(inject) {
		 ...
		 * @param {function} Callback returns the configuration string after configuration export is complete or Null in case of error
		 */
