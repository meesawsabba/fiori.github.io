...
sap.ui.define([
	...
	function _setVisibilityForAddAndRemoveIcons(oController) {
		...
		if(nIndex > 0 && oPropertyTypeState.aProperties !== undefined){
	...
	var oPropertyTypeState = oController.getView().getViewData().oPropertyTypeState;
	if(oPropertyTypeState !== undefined){
	...
	var sortPropertyType = sap.ui.core.mvc.Controller.extend("sap.apf.modeler.ui.controller.sortPropertyType", {
