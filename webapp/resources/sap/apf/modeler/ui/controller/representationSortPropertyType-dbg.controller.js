...
sap.ui.define([
...
], function(sortPropertyType, textManipulator, jQuery) {
    "use strict";
	var oTextManipulator = sap.apf.modeler.ui.utils.textManipulator;

	var representationSortPropertyType = sap.apf.modeler.ui.controller.sortPropertyType.extend("sap.apf.modeler.ui.controller.representationSortPropertyType", {
	...
	return representationSortPropertyType;
}, true);