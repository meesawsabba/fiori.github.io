sap.ui.define([
    ...
    function getMethods(oSupportStub) {
        ...
        function fnInit() {
            ...
            if (oSupportStub.isToolStub()) {
                ...
                window.fioriElementsPluginID = sPluginId;
        ...
        function fnExit() {
            if (oSupportStub.isToolStub()) {
                // tool instance
                window.fnFEPluginToolInstanceExit = undefined;
                ...
                // window instance
                window.fnFEPluginAppInstanceExit = undefined;
    ...
    return Plugin.extend("sap.ovp.support.DiagnosticsTool.DiagnosticsTool", {
        constructor: function (oSupportStub) {
            ...
            Object.assign(this, getMethods(oSupportStub));
        }
    });
});
