sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/library", "sap/ui/model/odata/ODataUtils", "sap/ovp/cards/generic/Component", "sap/ovp/cards/v4/generic/Component",
    ...
    "sap/ui/fl/write/api/ControlPersonalizationWriteAPI", "sap/ui/thirdparty/hasher", "sap/ui/model/analytics/odata4analytics",
    ...
    "sap/base/security/encodeURL", "sap/base/util/ObjectPath", "sap/ui/thirdparty/jquery", "sap/base/util/merge","sap/ui/fl/apply/api/FlexRuntimeInfoAPI","sap/ui/core/CustomData", "sap/ovp/cards/ovpLogger", "sap/base/util/isEmptyObject","sap/ovp/cards/semanticDateRangeTypeHelper", "sap/ui/model/Filter", "sap/ovp/placeholder/placeholderHelper"],

    function (Controller, SapMLibrary, ODataUtils, Component, ComponentV4, NavigationHandler, MessageBox, CommonUtils, PersonalizationUtils,
        ...
        ControlPersonalizationWriteAPI, hasher, oData4Analytics, BackgroundDesign, ListSeparators, TextAlign, CommonMethods, OvpResources,
        TemplateBaseExtension, ControllerExtension, OVPUtils, encodeURL, ObjectPath, jQuery, merge, FlexRuntimeInfoAPI, CustomData, ovpLogger, isEmptyObject,semanticDateRangeTypeHelper, FilterModel, placeholderHelper) {
        ...
        return Controller.extend("sap.ovp.app.Main", {
            ...
            onInit: function () {
                ...
                this.globalEventBus = sap.ui.getCore().getEventBus();
            ...
            recreateCard: function (oCardProperties) {
                ...
                if (oCard.template == "sap.ovp.cards.charts.analytical" || oCard.template == "sap.ovp.cards.charts.smart.chart" || oCard.template == "sap.ovp.cards.v4.charts.analytical") {
                ...
                oCard.settings.staticParameters = oOriginalAppDescriptor && oOriginalAppDescriptor.settings && oOriginalAppDescriptor.settings.staticParameters;
            ...
            fVerifyAndSetErrorOrCustomMessageCard: function (oReason, bSuccess) {
                ...
                for (key in aOrderedCards) {
                    ...
                    if (oCardItemsBinding && !CommonUtils.isODataV4(oCardController.oView.getModel())) {
                        ...
                        var sFilterInUrl;
                        try {
                            sFilterInUrl = sap.ui.model.odata.ODataUtils.createFilterParams(oRelevantFilters, oMetadata, oEntityType);
                        } catch (e) {
            ...
            organizeCards: function (aOrderedCards) {
                ...
                Promise.all(aCardsCreation).then(function () {
            ...
            _fnIsLoadDataOnGoButton : function (bGlobalFilterMandatoryItemsFilled) {
                ...
                var bDataLoad = false, bGlobalFiltertemFilled = true;
                if (sLoadBehaviour === "ifAnyFilterExist") {
                    var filtersWithValues = this.oState.oSmartFilterbar.getFiltersWithValues();
                    bDataLoad = true;
                    bGlobalFiltertemFilled = filtersWithValues.length ? true : false;
                ...
                return bDataLoad && bGlobalFilterMandatoryItemsFilled && bGlobalFiltertemFilled;
            },
            ...
            _processMacroFilters: function () {
                var oMacroFilterBar = this.getMacroFilterBar();
                var oConditions = oMacroFilterBar.getConditions();
                var aPaths = Object.keys(oConditions);
                var allFilters = [];
                if (aPaths.length > 0) {
                    var aFilters = aPaths.map(function(path) {
                        var oValue = oConditions[path] && oConditions[path][0];
                        if (oValue) {
                            return new FilterModel({
                                path: path,
                                operator: oValue.operator,
                                value1: oValue.values[0],
                                value2: oValue.values[1]
                            });
                        }
                    });
                    aFilters = aFilters.filter(function(filter) {
                        return filter !== undefined;
                    });
                    allFilters.push(new FilterModel({
                        filters : aFilters
                    }));    
                }

                this.aFilters = allFilters;
                ...
                this.oGlobalFilterLoadedPromise = new Promise(function (resolve, reject) {
                    ...
                    oGlobalFilter.attachInitialized(function () {
                        ...
                        if (this.oParseNavigationPromise) {
                            ...
                            this.oParseNavigationPromise.finally(function () {
            ...
            onShareButtonPress: function () {
                var oControl = this.getView().byId("sapOvpShareButton");
                if (oControl && (oControl.getVisible() && oControl.getEnabled())) {
                    this._onShareButtonAvailableAndPressed(oControl);
                }
            },
    
            _onShareButtonAvailableAndPressed: function (oButton) {
                ...
                if (!this._oShareActionButton) {
                    this._oShareActionButton = sap.ui.core.Fragment.load({
                ...
                this._oShareActionButton.then(function(oControl){
                        oControl.openBy(oButton);
                });
            },
            ...
            _loadCardComponent: function (sComponentName) {
                ...
                if (!this.oLoadedComponents[sComponentName]) {
                    this.oLoadedComponents[sComponentName] = sap.ui.core.Component.load({
                        name: sComponentName,
                        url: sUrl,
                        manifest: false
            ...
            _checkIsCardValid: function (sCardTemplate) {
                ...
                if ((oComponentClass !== Component) && !(oComponentClass.prototype instanceof Component || oComponentClass.prototype instanceof ComponentV4)) {
                    return false;
                }
                ...
                if ((oComponentClass.prototype.createContent != Component.prototype.createContent) && (oComponentClass.prototype.createContent != ComponentV4.prototype.createContent)) {
                    return false;
                }

                if ((oComponentClass.prototype.getPreprocessors != Component.prototype.getPreprocessors) && (oComponentClass.prototype.getPreprocessors != ComponentV4.prototype.getPreprocessors)) {
                    return false;
                }
            ...
            _createCardComponent: function (oView, oModel, card) {
                ...
                if (card.template && this._checkIsCardValid(card.template)) {
                    ...
                    this.getOwnerComponent().runAsOwner(function () {
                        sap.ui.core.Component.create(oComponentConfig).then(function (oComponent) {
            ...
            createCard: function (card) {
                ...
                if (CommonUtils.isODataV4(oModel)){
                    promiseArray = [
                        oModel.getMetaModel().requestObject("/" + card.settings.entitySet),
                    ...
                    promiseArray = [
                        ...
                        this.oGlobalFilterLoadedPromise,
                        this.oLoadedComponents[card.template],
                        this.oLoadedComponents["sap.ovp.cards.error"]
                    ];
                }
            ...
            _initFlexibilityPersonalization: function () {
                ...
                for (var i = 0; i < aOrderedCards.length; i++) {
                    aOrderedCards[i].addCustomData(new CustomData({
                ...
                this.oFlexibilityPersonalizationPromise = new Promise(function (resolve, reject) {
                    ...
                    FlexRuntimeInfoAPI.waitForChanges({ selectors: aOrderedCards }).then(function () {
            ...
            _parseNavigationVariant: function () {
                ...
                this.oParseNavigationPromise = new Promise(function(resolve, reject){
                    return oNavigationHandlerr.parseNavigation().done(function(oAppData, oURLParameters, sNavType) {
            ...
            _setNavigationVariantToGlobalFilter: function (oAppData, oURLParameters, sNavType) {
                return new Promise(function (resolve, reject) {
                    ...
                    var oGlobalFilter = this.getGlobalFilter();
                    var oData = this.getUIModel().oData;
                    var oSmartFilterbar = this.oState.oSmartFilterbar;
                    var semanticDates = this.oGlobalFilter.getUiState().getSemanticDates();
                        ...
                        case "iAppState":
                            ...
                            if (oAppData.selectionVariant) {
                                ...
                                if (oCurrentVariant.SelectionVariantID.length !== 0) {
                                    var aAllVariantKeys = oGlobalFilter.getVariantManagement().getVariantItems().map(function (item) {
                                        return item.getKey();
                                    });
                                ...
                                var oSelectionVariant, aSelectionVariantProperties, bMarkDirty = false;
