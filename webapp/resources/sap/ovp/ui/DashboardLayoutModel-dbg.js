    ...
    function(CommonUtils, merge) {
        ...
        LayoutModel.prototype._buildGrid = function (bUseManifest) {
            if (this.aCards.length === 0 || bUseManifest) {
                ...
                this.aCards = merge([], this.uiModel.getProperty("/cards"));
            }
            ...
            if (!oCard.settings.defaultSpan) {
                ...
                if (oCard.settings.defaultSpan.showOnlyHeader) {
                    ...
                    if (oCard.template === 'sap.ovp.cards.linklist' || oCard.template === 'sap.ovp.cards.v4.linklist') {
                        ...
                        oCard.dashboardLayout.rowSpan = 8;
        ...
        LayoutModel.prototype._arrangeCards = function (oCard, newCardPosition, dragOrResize, aDragOrResizeChanges) {
            var originalCardCopy = merge({}, oCard);
        ...
        LayoutModel.prototype._getDefaultCardItemHeightAndCount = function (oCardProperties) {
            ...
            if (oCardProperties) {
                ...
                if (cardType == "sap.ovp.cards.list" || cardType == "sap.ovp.cards.v4.list") {
                ...
                } else if (cardType == "sap.ovp.cards.table" || cardType == "sap.ovp.cards.v4.table") {
                    iNoOfItems = CARD_PROPERTY["Table"]["itemLength"];
                    iItemHeight = CARD_PROPERTY["Table"]["itemHeight"];
                } else if (cardType === "sap.ovp.cards.linklist" || cardType.template === 'sap.ovp.cards.v4.linklist') {
