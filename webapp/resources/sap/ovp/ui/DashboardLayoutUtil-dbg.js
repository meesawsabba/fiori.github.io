sap.ui.define([
    ...
    function(Rearrange, DashboardLayoutModel, CommonUtils, Device, jQuery, merge, ovpLogger, jUtils, cardPositionHelper) {
    "use strict";
    ...
    DashboardLayoutUtil.prototype.calculateCardProperties = function (sCardId) {
        ...
        if (oGenCardCtrl) {
            ...
            } else if (oCard.template === 'sap.ovp.cards.linklist' || oCard.template === 'sap.ovp.cards.v4.linklist') {
                if (oCard.settings.listFlavor === 'carousel') {
                    minCardHeight = iHeaderHeight + jUtils.getOuterHeight(document.querySelector('.sapOvpCarouselContentHeader')) + 240 + jUtils.getOuterHeight(document.querySelector('.sapMCrslControlsBottom.sapMCrslControls'));
                } else {
        ...
        try {
            if ((cardLayout.autoSpan || !cardLayout.visible) && oGenCardCtrl) {
                ...
                if (oCardBinding && cardSizeProperties) {
                    ...
                    } else if (oCard.template === 'sap.ovp.cards.list' || oCard.template === 'sap.ovp.cards.v4.list') {
    ...
    DashboardLayoutUtil.prototype._positionCards = function (aCards) {
        ...
        aCards.forEach(function (oCardObj) {
            ...
            if (element) {
                ...
                if (((oCardObj.template === "sap.ovp.cards.list" || oCardObj.template === "sap.ovp.cards.v4.list")  && oCardObj.dashboardLayout.colSpan === 2) ||
                    ((oCardObj.template === "sap.ovp.cards.linklist" || oCardObj.template === "sap.ovp.cards.v4.linklist") && oCardObj.settings.listFlavor === 'carousel' && oCardObj.dashboardLayout.colSpan === 3)) {
                    element.classList.add('sapOvpNotResizableRight');
                }
                if ((oCardObj.template === "sap.ovp.cards.linklist" || oCardObj.template === "sap.ovp.cards.v4.linklist") && oCardObj.settings.listFlavor === 'carousel' && oCardObj.dashboardLayout.rowSpan === 45) {
    ...
    DashboardLayoutUtil.prototype.updateCardSize = function (sCardId, ghostHeight, ghostWidth) {
        ...
        if ((oCard.template === 'sap.ovp.cards.linklist' || oCard.template === 'sap.ovp.cards.v4.linklist') && oCard.settings.listFlavor === 'carousel') {
