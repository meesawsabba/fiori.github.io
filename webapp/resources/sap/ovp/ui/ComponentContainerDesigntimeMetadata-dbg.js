...
sap.ui.define([
    ...
    ], function (jQuery, CommonUtils, SettingsUtils, ElementMover, OverlayRegistry, OverlayUtil, Plugin, BindingsExtractor, MetadataPropagationUtil, Utils, OvpResources, OVPUtils, ovpLogger) {
        "use strict";
        ...
        var oElementMover = new ElementMover(),
            ...
            _iterateOverAllSiblings = function (oSelectedElement, fnStep) {
                var oOverlay = OverlayRegistry.getOverlay(oSelectedElement),
                    ...
                    aSiblingOverlays = oParentOverlay && OverlayUtil.findAllSiblingOverlaysInContainer(oOverlay, oParentOverlay);

                aSiblingOverlays && aSiblingOverlays.forEach(function (oSiblingOverlays) {
