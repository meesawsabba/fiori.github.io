sap.ui.define(["sap/ui/thirdparty/jquery", "sap/ovp/cards/CommonUtils", "sap/ovp/ui/UIActions",
    "sap/ui/Device", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "sap/ovp/app/resources", "sap/ovp/app/OVPUtils", "sap/ui/events/F6Navigation", "sap/ui/events/KeyCodes", "sap/ovp/cards/jUtils"],
    function (jQuery, CommonUtils, UIActions, Device, Control, ResizeHandler, OvpResources, OVPUtils, F6Navigation, KeyCodes, jUtils) {
        "use strict";
        ...
        */
        ...
        EasyScanLayout.prototype.resizeHandler = function (colResList) {
            ...
            var resObject;
            if (document.querySelectorAll(".sapFDynamicPageContent").length > 0) {
        ...
        EasyScanLayout.prototype.headerMargin = function (that) {
            ...
            var screenWidth = (parseInt(window.getComputedStyle(document.querySelector('.sapFDynamicPageTitleWrapper'),null).getPropertyValue("width").split("px")[0], 10) * 1.0) / iRemToPx;
            if (document.querySelectorAll(".sapFDynamicPageContent").length > 0) {
                width = window.innerWidth;
            }
            for (var i = 0; i < colResList.length; i++) {
            ...
            if (Device.system.desktop) {
                ...
                if (document.querySelectorAll(".sapFDynamicPageContentFitContainer").length > 0) {
                    contentWidth = document.querySelectorAll(".sapFDynamicPageContentFitContainer")[0].clientWidth;
                }

                if (screenWidth === contentWidth) {
                    var dynamicPageTitle = document.querySelector('.sapFDynamicPageTitle') || undefined;
