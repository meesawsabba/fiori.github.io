...
/**
 * Initialization Code and shared classes of library sap.ovp (1.96.0)
 */
sap.ui.define([
	...
	sap.ui.getCore().initLibrary({
		...
		dependencies: ["sap.ui.core","sap.ui.layout","sap.ui.generic.app",
			"sap.m", "sap.f", "sap.ui.comp", "sap.ui.rta","sap.suite.ui.microchart", "sap.viz", "sap.fe.placeholder", "sap.fe.macros"],
		types: [],
		interfaces: [],
		controls: [],
		elements: [],
