sap.ui.define([
    ...
    "sap/base/util/merge"
], function (CardChangeHandler, RemoveCardContainer, OverlayRegistry,
             ComponentContainer, MessageToast, SettingsConstants, SettingsUtils, CommonUtils, OvpResources, merge) {
    "use strict";
    return {
        "moveControls": {
                ...
                applyChange : function(oChange, oControl, mPropertyBag){
                    ...
                    for (i = 0; i < aCards.length; i++) {
                        if (oCardProperties.id.lastIndexOf(CommonUtils._getLayerNamespace() + "." + aCards[i].id, 0) === 0) {
                            ...
                            oCardProperties.dashboardLayout = merge({}, oCard.dashboardLayout);
        ...
        "viewSwitch": CardChangeHandler.PersonalizationDefaultConfig,
        "visibility": CardChangeHandler.PersonalizationDefaultConfig,
        "dragOrResize": CardChangeHandler.PersonalizationDefaultConfig
    };
}, /* bExport= */true);