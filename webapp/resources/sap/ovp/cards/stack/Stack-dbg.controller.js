sap.ui.define([
    ...
    function (CardController, SapMLibrary, jQuery, ObjectStream, AnnotationHelper, Device, BindingParser, ComponentContainer,
              Link, CustomData, Icon, FlexItemData, Text, VBox, OvpResources, merge, ovpLogger, jUtils, UIComponent) {
        "use strict";
        ...
        return CardController.extend("sap.ovp.cards.stack.Stack", {
            ...
            onAfterRendering: function () {
                ...
                this.ovpLayout = sap.ui.getCore().byId(this.oCardComponent._sOwnerId + "---mainView--ovpLayout");
                /**
            ...
            _createObjectStream: function () {
                ...
                if (this.bStackFlavorAssociation) {
                    if (sObjectStreamCardsTemplate === "sap.ovp.cards.quickview") {
                        oLogger.error("objectStreamCardsTemplate cannot be 'sap.ovp.cards.quickview' when objectStreamCardsNavigationProperty is provided");
                    ...
                    if (sObjectStreamCardsTemplate !== "sap.ovp.cards.quickview") {
                        oLogger.error("objectStreamCardsTemplate must be 'sap.ovp.cards.quickview' when objectStreamCardsNavigationProperty is not provided");
                        this.bSetErrorState = true;
                        //this.setErrorState();
                        return;
                    }
...
//                    var oComponentContainer = new ComponentContainer();
            ...
            openStack: function () {
                ...
                if (this.oObjectStream.getNewContentAvailable()) {
                    var quickViewCardPromiseArray = [];
                    for (var i = this.quickViewCardCount; i < this.initialLoadCardLength; i++) {
                        quickViewCardPromiseArray.push(this._renderQuickViewCards(this.quickViewCardContextArray[i].sId, this.quickViewCardContextArray[i].oContext, this.quickViewCardContextArray[i].oComponentContainer));
                    }
