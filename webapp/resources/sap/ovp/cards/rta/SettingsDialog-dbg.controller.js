sap.ui.define([
    ...
    function (Controller, JSONModel, OVPCardAsAPIUtils, settingsUtils, PayLoadUtils, SettingsConstants,
        MessageBox, Filter, FilterOperator, ChangeReason, LinkAnnotationHelper, V4CardAnnotationHelper, CardAnnotationHelper,
        IconPool, ViewType, Dialog, Button, CommonUtils, Device, OvpResources, OVPUtils, deepEqual, merge, ovpLogger) {
        "use strict";
        ...
        return Controller.extend("sap.ovp.cards.rta.SettingsDialog", {
            ...
            createValueHelpDialogForInternalUrl: function (oEvent) {
                ...
                this._oEvent = Object.assign({}, oEvent);
                ...
                // Links Dialog
                var oLinksDialogContent = new sap.ui.core.mvc.XMLView("linksDialogContent", {
            ...
            onChangeVisualPress: function (oEvent) {
                ...
                // Icons Dialog
                var oIconsDialogContent = new sap.ui.core.mvc.XMLView("iconsDialogContent", {
            ...
            validateComboBox: function (oCardManifestSettings, sPropertyType, bKPICheckboxFlag) {
                ...
                if ((sPropertyType === "KPICheckBox" && bKPICheckboxFlag && oCardManifestSettings.entitySet) ||
                    ...
                    sErrorText = OvpResources.getText("OVP_KEYUSER_INPUT_ERROR");
                    this.handleValueStateofComboBox(sErrorText, OVPUtils.Annotations.title, "sapOvpCardTitle", true);
                    if (oCardManifestSettings.template === "sap.ovp.cards.linklist" || oCardManifestSettings.template === "sap.ovp.cards.v4.linklist") {
            ...
            onSeePress: function () {
                ...
                var oKPIItemDialogContent = new sap.ui.core.mvc.XMLView("KPIItemDialogContent", {
            ...
            openLineItemValueHelpDialog: function (oEvent) {
                ...
                // LineItem Dialog
                var oLineItemDialogContent = new sap.ui.core.mvc.XMLView("lineItemDialogContent", {
