sap.ui.define(["sap/ovp/cards/v4/generic/Card.controller", "sap/ui/thirdparty/jquery", "sap/ui/model/json/JSONModel",
    "sap/ovp/cards/OVPCardAsAPIUtils", "sap/ovp/cards/CommonUtils", "sap/ovp/cards/v4/V4AnnotationHelper", "sap/ovp/app/OVPUtils", "sap/ovp/cards/ovpLogger", "sap/ovp/cards/jUtils", "sap/ovp/cards/Filterhelper"],
        ...
        return CardController.extend("sap.ovp.cards.v4.list.List", {
            ...
            _getMinMaxObjectFromContext: function (noOfItems) {
                ...
                var oEntitySet = this.getEntitySet(),
                    ...
                    var aRecords = this.getMetaModel().getData(sAnnotationPath).$Annotations[oEntitySet.$Type][sAnnotationPath];
