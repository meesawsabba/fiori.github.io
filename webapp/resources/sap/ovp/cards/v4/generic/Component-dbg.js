sap.ui.define([
    ...
    function (UIComponent, JSONModel, CommonUtils, Device, ResourceModel, ViewType, merge, OVPUtils, ovpLogger, V4AnnotationHelper) {
        "use strict";
            ...
            getPreprocessors: function (pOvplibResourceBundle) {
                ...
                if (oCardProperties.state !== "Error") {
                    ...
                    if (oSettings && oSettings.kpiAnnotationPath) {
                        ...
                        if (oKpiAnnotation && (contentFragment === "sap.ovp.cards.v4.charts.analytical.analyticalChart" || contentFragment === "sap.ovp.cards.v4.charts.smart.analyticalChart")) {
