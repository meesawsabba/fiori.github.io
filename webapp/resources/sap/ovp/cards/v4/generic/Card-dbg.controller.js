sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
        ...
        "sap/ovp/cards/v4/V4AnnotationHelper", "sap/ui/model/odata/AnnotationHelper",
    ...
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils, KeyCodes, isPlainObject, merge, ovpLogger, jUtils, isEmptyObject, Filterhelper, oDataAnnotationHelperV4, openWindow, Component, placeholderHelper) {
        "use strict";
        ...
        return Controller.extend("sap.ovp.cards.v4.generic.Card", {
            ...
            onExit: function() {
                var that = this;
                this.GloabalEventBus.unsubscribe(
                    "OVPGlobalfilter",
            ...
            checkNavigation: function () {
                ...
                } else if (oCardPropsModel && oCardPropsModel.getProperty("/template") === "sap.ovp.cards.v4.linklist" &&
            ...
            onHeaderClick: function (oEvent) {
                ...
                if (OVPCardAsAPIUtils.checkIfAPIIsUsed(this)) {
                    ...
                    if (template == "sap.ovp.cards.v4.linklist" && oCardPropertiesModel.getProperty("/staticContent") !== undefined && sTargetUrl) {
            ...
            getEntityNavigationEntries: function (oContext, sAnnotationPath) {
                        ...
                        if (kpiAnnotationPath && sCardType === "sap.ovp.cards.charts.analytical") {
                            ...
                            if (oDetail.RecordType === "com.sap.vocabularies.UI.v1.KPIDetailType") {
                                if (sSemanticObject && sAction) {
                                    ...
                                    oLogger.error("Invalid Semantic object and action configured for annotation " + oDetail.RecordType);
                                }
                            }
                        }
                    }
                ...
                if (Array.isArray(aRecords)) {
                    ...
                    for (var i = 0; i < aRecords.length; i++) {
                        ...
                        if (aRecords[i].$Type === "com.sap.vocabularies.UI.v1.DataFieldWithUrl" && !aRecords[i].Url.UrlRef) {
                            ...
                            var sBindingString = oDataAnnotationHelperV4.format(aRecords[i].Url, { context: oEntityBindingContext });
            ...
            _getEntityNavigationParameters: function (oEntity, oCustomParameters, oContext) {
                ...
                if (!oStaticLinkList) {
                    ...
                    if (oEntity) {
                        var key,
                            oEntityTypePropertyKeys = oEntityType && oEntityType.property && Object.keys(oEntityType.property);
            ...
            _removeSensitiveAttributesFromNavSelectionVariant: function (oEntityType, oNavSelectionVariant) {
                for (var i = 0; i < oEntityType.property.length; i++) {
                    if (oEntityType.property[i]["com.sap.vocabularies.PersonalData.v1.IsPotentiallySensitive"] && oEntityType.property[i]["com.sap.vocabularies.PersonalData.v1.IsPotentiallySensitive"]) {
