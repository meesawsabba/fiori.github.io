...
//			var entityset = this.getEntitySet();
                    ...
                    if (oChartAnnotation.DimensionAttributes.length === 1 && bEnableStableColors && content.getVizType() === "donut"
                        ...
                        if (content && oVizProps && oVizProps.plotArea){
                            ...
                            if (oDimension){
                                ...
                                var sDimensionLabel = oDimension["@com.sap.vocabularies.Common.v1.Label"] ? oDimension["@com.sap.vocabularies.Common.v1.Label"] : colorPaletteDimension;
                ...
                for (var i = 0; i < oDataClone.results.length; i++) {
                    ...
                    for (var l = 0; l < finalMeasures.length; l++ ) {
                        obj[finalMeasures[l]] = oDataClone.results[i] && oDataClone.results[i][finalMeasures[l] + "Aggregate"];
                    }
                    data.push(obj);
                }
                oModel.setData(data);
