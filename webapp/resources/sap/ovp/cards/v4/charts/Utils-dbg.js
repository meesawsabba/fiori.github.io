...
sap.ui.define([
    ...
    function (jQuery, each, merge, ovpLogger) {
        "use strict";
        ...
        oUtils.checkIfDataExistInEvent = function(oEvent) {
            if (oEvent.getSource() && oEvent.getSource().getCurrentContexts()) {
                var elements = oEvent.getSource().getCurrentContexts();
