sap.ui.define(["sap/ovp/cards/v4/generic/Card.controller", "sap/ovp/cards/v4/charts/VizAnnotationManager",
    "sap/viz/ui5/data/FlattenedDataset", "sap/ovp/cards/OVPCardAsAPIUtils", "sap/ovp/app/resources", "sap/base/util/each", "sap/ovp/cards/ovpLogger",  "sap/ovp/cards/Filterhelper", "sap/ui/model/FilterOperator", "sap/ui/base/SyncPromise", "sap/ovp/cards/v4/charts/Utils"],
    function (CardController, VizAnnotationManager, FlattenedDataset, OVPCardAsAPIUtils, OvpResources, each, ovpLogger, Filterhelper, FilterOperator, SyncPromise, Utils) {
        "use strict";
        ...
        return CardController.extend("sap.ovp.cards.charts.v4.analytical.analyticalChart", {
            onInit: function () {
                    ...
                    if (that.getView().getModel().getMetaModel().getData) {
                        ...
                        try {
                            if (relfilters && relfilters.aFilters) {
                                fetchFilter(relfilters, cardBinding, {}).then(function(filterParameters) {
                ...
                function fetchFilter(oFilter, cardBinding, mLambdaVariableToPath, bWithinAnd) {
                    var sResolvedPath;
                    ...
                    if (oFilter.aFilters) {
                        return SyncPromise.all(oFilter.aFilters.map(function (oSubFilter) {
                            return fetchFilter(oSubFilter, cardBinding, mLambdaVariableToPath, oFilter.bAnd);
                    ...
                    switch (oFilter.sOperator) {
                        ...
                        case FilterOperator.NB :
                            sFilter = wrap(sFilterPath + " lt " + sValue + " or " + sFilterPath + " gt "
                                + setCase(Filterhelper.formatLiteral(oFilter.oValue2, sEdmType)), bWithinAnd);
                            break;
...
//				sap.ovp.cards.charts.VizAnnotationManager.hideDateTimeAxis(vizFrame);
                    ...
                    if (binding && binding.getPath()) {
                        ...
                        sap.ui.core.Fragment.load("sap.ovp.cards.charts.generic.noData").then(function(oControl){
            ...
            onAfterRendering: function () {
                ...
                if (!OVPCardAsAPIUtils.checkIfAPIIsUsed(this)) {
                    ...
                    if (oMainComponent.getGlobalFilter()) {
                        relfilters = Filterhelper._getEntityRelevantFilters(entityType,oMainComponent.oGlobalFilter.getFilters());
                    }
