sap.ui.define(["sap/ovp/cards/v4/V4AnnotationHelper", "sap/ui/model/odata/AnnotationHelper",
    "sap/ui/model/FilterOperator", "sap/ovp/cards/ovpLogger"],
    function (V4AnnotationHelper, OdataAnnotationHelper, FilterOperator, ovpLogger) {
        "use strict";
        ...
        function formatItems(iContext, oEntitySet, oHeaderAnnotation) {
            ...
            if (oSelectionVariant || !!aParameters) {
                if ((oSelectionVariant && oSelectionVariant.Parameters) || !!aParameters) {
                    ...
                    sEntitySetPath = V4AnnotationHelper.resolveParameterizedEntitySet(iContext.getSetting("dataModel"), oEntitySet,
