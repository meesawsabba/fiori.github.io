        ...
        function hasTimeSemantics(aDimensions, config, dataModel, entitySet) {
            ...
            for (var index = 0; index < aDimensions.length; index++) {
                ...
                if (oMetadata && oMetadata[dimensionName]) {
                    ...
                    sapSemanticsV4 = oMetadata[dimensionName]["com.sap.vocabularies.Common.v1.IsCalendarYear"] ||
...
//		}
            ...
            if (!bEnableStableColors && aSupportedChartTypesForSemanticColors.indexOf(chartContext.ChartType.EnumMember) >= 0 && oColorPalette && Object.keys(oColorPalette).length >= 2 && Object.keys(oColorPalette).length <= 4) {
...
//		var minFractionDigits = Number(dataContext.NumberFormat.NumberOfFractionalDigits.Int);
            ...
            */
            ...
            if (bEnableStableColors && aSupportedChartTypesForStableColors.indexOf(chartContext.ChartType.EnumMember) >= 0 && !bColorRestriction) {
