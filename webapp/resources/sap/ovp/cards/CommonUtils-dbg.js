sap.ui.define(["sap/ovp/cards/OVPCardAsAPIUtils", "sap/ui/Device",
 "sap/base/util/UriParameters", "sap/base/util/each", "sap/ui/model/json/JSONModel", "sap/ovp/cards/ovpLogger"],
    function (OVPCardAsAPIUtils, Device, UriParameters, each, JSONModel, ovpLogger) {
        "use strict";
        ...
        return {
            ...
            isODataV4: function (oModel) {
                return (oModel && oModel.getODataVersion && oModel.getODataVersion() == "4.0") || false;
            }
        };
    },
    /* bExport= */true);
