sap.ui.define(["sap/ovp/cards/generic/Card.controller", "sap/ui/thirdparty/jquery", "sap/ui/model/json/JSONModel",
    "sap/ovp/cards/OVPCardAsAPIUtils", "sap/ovp/cards/CommonUtils", "sap/ovp/cards/AnnotationHelper", "sap/ovp/app/OVPUtils", "sap/ovp/cards/ovpLogger", "sap/ovp/cards/jUtils", "sap/ovp/app/FilterHelper"],
    function (CardController, jQuery, JSONModel, OVPCardAsAPIUtils, CommonUtils, AnnotationHelper, OVPUtils, ovpLogger, jUtils, FilterHelper) {
        "use strict";
            ...
            onInit: function () {
                ...
                this.eventhandler = function (sChannelId, sEventName, aFilters) {
                    ...
                    if (oEntityType && oFilterModel) {
                        ...
                        try {
                            var oListBinding = that.getCardItemsBinding();
                            if (oListBinding) {
                                oListBinding.filter(aAllFilters);
                            }
