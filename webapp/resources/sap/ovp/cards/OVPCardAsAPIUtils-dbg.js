sap.ui.define(["sap/ovp/cards/ovpLogger"],
    function (ovpLogger) {
        "use strict";
        ...
        function _checkIfModelExists(oCardManifest) {
            ...
            if (oCardManifest.template === "sap.ovp.cards.error" || 
                ((oCardManifest.template === "sap.ovp.cards.linklist" || oCardManifest.template === "sap.ovp.cards.v4.linklist") && 
                                ...
                                if (!!sContainerId && typeof sContainerId === 'string') {
                                    if (!!oView) {
                                        ...
                                        if (!_checkIfModelExists(oCardManifest)) {
                                            ...
                                            if (oModel && oModel.getODataVersion && oModel.getODataVersion() == "4.0") {
                                                getMetaModelPromise = oModel.getMetaModel().requestObject("/" + oCardManifest.settings.entitySet);
                                            } else {
