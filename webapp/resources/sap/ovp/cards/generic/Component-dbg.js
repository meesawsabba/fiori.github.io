sap.ui.define([
    ...
    function (UIComponent, JSONModel, CommonUtils, Device, ResourceModel, ViewType, merge, OVPUtils, ovpLogger) {
        "use strict";
        ...
        return UIComponent.extend("sap.ovp.cards.generic.Component", {
            ...
            getPreprocessors: function (pOvplibResourceBundle) {
                ...
                if (oModel && CommonUtils.isODataV4(oModel)) { // OData V4 data model
                ...
                } else if (oModel && oSettings.entitySet) { // OData V2 data model
                    oMetaModel = oModel && oModel.getMetaModel();
                ...
                if ((oAdditionalData.template === "sap.ovp.cards.linklist" || oAdditionalData.template === "sap.ovp.cards.v4.linklist") && !!oSettings.staticContent) {
            ...
            createContent: function () {
                ...
                var oView = new sap.ui.core.mvc.XMLView(oComponentData.containerId === "dialogCard" ? undefined : sIdForCardView, oViewConfig);
                /**
                 * end
                 */
