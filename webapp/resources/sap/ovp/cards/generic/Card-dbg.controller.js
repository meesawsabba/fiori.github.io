sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
    ...
    "sap/ovp/app/OVPUtils", "sap/ui/events/KeyCodes", "sap/base/util/isPlainObject", "sap/base/util/merge", "sap/ovp/cards/ovpLogger", "sap/ovp/cards/jUtils", "sap/base/util/isEmptyObject", "sap/ui/util/openWindow", "sap/ovp/placeholder/placeholderHelper"],
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils, KeyCodes, isPlainObject, merge, ovpLogger, jUtils, isEmptyObject, openWindow, placeholderHelper) {
        "use strict";
        ...
        return Controller.extend("sap.ovp.cards.generic.Card", {
            ...
            _handleCountHeader: function () {
                ...
                if (countFooter) {
                    ...
                    if (oItemsBinding) {
                        ...
                        oItemsBinding.attachChange(function (oEvent) {
                            this.setHeaderCounter(oItemsBinding, countFooter, oEvent);
                        }.bind(this));
                    }
                } else {
            ...
            setHeaderCounter: function (oItemsBinding, countHeader, oEvent) {
                ...
                if (oItemsBinding.isLengthFinal()) {
                    ...
                    if (oEvent && oEvent.getParameters().data && oEvent.getParameters().data.results) {
            ...
            setErrorState: function () {
                ...
                sap.ui.core.Component.create(oComponentConfig).then(function(oLoadingCard){
