sap.ui.define(["sap/ovp/cards/generic/Card.controller", "sap/ui/thirdparty/jquery",
    ...
    "sap/ui/core/ResizeHandler", "sap/m/MessageToast", "sap/m/Image", "sap/ovp/app/resources", "sap/ovp/app/OVPUtils", "sap/ovp/cards/ovpLogger", "sap/ui/util/openWindow", "sap/ovp/app/FilterHelper"],

    function (CardController, jQuery, OVPCardAsAPIUtils, CommonUtils, List, ResizeHandler, MessageToast, Image, OvpResources, OVPUtils, ovpLogger, openWindow, FilterHelper) {
        "use strict";
            ...
            onInit: function () {
                ...
                this.eventhandler = function (sChannelId, sEventName, aFilters) {
                    ...
                    if (oEntityType && oFilterModel) {
                        ...
                        try {
                            var oLinkListBinding = that.getCardItemsBinding();
                            if (oLinkListBinding) {
                                oLinkListBinding.filter(aAllFilters);
                            }
