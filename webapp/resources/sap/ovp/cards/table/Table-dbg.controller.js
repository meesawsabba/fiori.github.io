sap.ui.define(["sap/ovp/cards/generic/Card.controller", "sap/ui/thirdparty/jquery", "sap/ovp/cards/OVPCardAsAPIUtils",
    "sap/ovp/cards/CommonUtils", "sap/ovp/app/OVPUtils", "sap/ovp/cards/ovpLogger", "sap/ovp/app/FilterHelper"],
    function (CardController, jQuery, OVPCardAsAPIUtils, CommonUtils, OVPUtils, ovpLogger, FilterHelper) {
        "use strict";
            ...
            onInit: function () {
                ...
                this.eventhandler = function (sChannelId, sEventName, aFilters) {
                    ...
                    if (oEntityType && oFilterModel) {
                        ...
                        try {
                            var oTableBinding = that.getCardItemsBinding();
                            if (oTableBinding) {
                                oTableBinding.filter(aAllFilters);
                            }
